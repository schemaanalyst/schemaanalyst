...
public class TestCalculator {
	...
	public void ochiaiTest1() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 2, 0, false);
	...
	public void ochiaiTest2() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 3, 2, false);
		Calculator.calculateOchiai(r);
	...
	public void ochiaiTest3() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 0, 2, false);
		Calculator.calculateOchiai(r);
	...
	public void ochiaiTest4() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 6, 40, 20, 2, false);
		Calculator.calculateOchiai(r);
	...
	public void tarantulaTest1() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 5, 2, false);
	...
	public void tarantulaTest2() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 4, 2, false);
		Calculator.calculateTarantula(r);
	...
	public void tarantulaTest5() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 5, 0, false);
		Calculator.calculateTarantula(r);
	...
	public void JaccardTest4() {
		ResultMatrixRow r = new ResultMatrixRow("first constraint", "first mutant", 2, 5, 2, 2, false);
		Calculator.calculateJaccard(r);
