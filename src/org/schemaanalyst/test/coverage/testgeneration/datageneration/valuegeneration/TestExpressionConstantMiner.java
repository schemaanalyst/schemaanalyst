...
public class TestExpressionConstantMiner {
    ...
    public void testSimpleConstant() {
        ...
        ValueLibrary library = new ExpressionConstantMiner().mine(constantExpression);
    ...
    public void testComplexExpression() {
        ...
        ValueLibrary library = new ExpressionConstantMiner().mine(new ParenthesisedExpression(inExpression));
    ...
    public void testSchema() {
        ...
        ValueLibrary library = new ExpressionConstantMiner().mine(schema);
