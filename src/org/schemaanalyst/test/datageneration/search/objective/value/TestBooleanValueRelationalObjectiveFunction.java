...
public class TestBooleanValueRelationalObjectiveFunction {
    ...
    Object[] optimalValues() {
        return $(
                ...
                // same tests above should pass regardless of nullIsTrue, as there are no nulls
                $(new BooleanValue(true), RelationalOperator.EQUALS, new BooleanValue(true), false),
                $(new BooleanValue(false), RelationalOperator.EQUALS, new BooleanValue(false), false),
                $(new BooleanValue(false), RelationalOperator.NOT_EQUALS, new BooleanValue(true), false),
                $(new BooleanValue(true), RelationalOperator.NOT_EQUALS, new BooleanValue(false), false),                
    ...
    public void testOptimal(BooleanValue lhs, RelationalOperator op, BooleanValue rhs, boolean nullIsTrue) {        
        BooleanValueRelationalObjectiveFunction objFun = 
                new BooleanValueRelationalObjectiveFunction(op, nullIsTrue);
    ...
    public void testWorst(BooleanValue lhs, RelationalOperator op, BooleanValue rhs, boolean nullIsTrue) {        
        BooleanValueRelationalObjectiveFunction objFun = 
                new BooleanValueRelationalObjectiveFunction(op, nullIsTrue);
    ...
    public void testThrowsException(BooleanValue lhs, RelationalOperator op, BooleanValue rhs, boolean nullIsTrue) {        
        boolean fail = true;
        try {        
            BooleanValueRelationalObjectiveFunction objFun = 
                    new BooleanValueRelationalObjectiveFunction(op, nullIsTrue);
