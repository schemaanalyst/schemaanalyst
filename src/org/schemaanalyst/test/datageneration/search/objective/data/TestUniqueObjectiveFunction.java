...
public class TestUniqueObjectiveFunction {
    ...
    Object[] oneColumnTestValues() {
        return $(
                ...
                $(empty, oneColOneRow, true, false, true),
                $(empty, oneColOneRow, true, true, true),
                $(empty, oneColOneRow, false, false, false),
                $(empty, oneColOneRow, false, true, false),         
                
                // non-uniqueness of the state should be ignored
                $(oneColOneRow, oneColTwoRowsTwoSameValues, true, false, true),
                $(oneColOneRow, oneColTwoRowsTwoSameValues, true, true, true),
                $(oneColOneRow, oneColTwoRowsTwoSameValues, false, false, false),
                $(oneColOneRow, oneColTwoRowsTwoSameValues, false, true, false),                  
                ...
                $(oneColTwoRowsOneNull, oneColTwoRowsTwoDiffValues, true,
                        false, false),
                $(oneColTwoRowsOneNull, oneColTwoRowsTwoDiffValues, true, true,
                        true),
                $(oneColTwoRowsOneNull, oneColTwoRowsTwoDiffValues, false,
                        false, false),
                $(oneColTwoRowsOneNull, oneColTwoRowsTwoDiffValues, false,
                        true, true));
    }
    ...
    public void oneColumnTests(Integer[] dataValues, Integer[] stateValues,
    ...
    Integer[] twoColsOneRow1 = { 1, 
                                 1 };

    Integer[] twoColsOneRow2 = { 2, 
                                 2 };
