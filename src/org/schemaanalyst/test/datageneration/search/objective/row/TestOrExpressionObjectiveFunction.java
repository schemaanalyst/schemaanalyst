...
import org.schemaanalyst.datageneration.search.objective.row.OrExpressionObjectiveFunction;
...
public class TestOrExpressionObjectiveFunction {
    ...
    public void testExpression(OrExpression exp, boolean goalIsToSatisfy, boolean nullAccepted, boolean optimal) {
