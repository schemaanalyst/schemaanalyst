...
import org.schemaanalyst.datageneration.search.directedrandom.ExpressionConstraintHandler;
...
public class TestExpressionConstraintHandler {
    ...
    public void test(Integer[] originalValues, Integer[] finalValues, boolean goalIsToSatisfy, boolean allowNull) {
        ...
        ExpressionConstraintHandler ech = new ExpressionConstraintHandler(objFun, cellRandomiser);
