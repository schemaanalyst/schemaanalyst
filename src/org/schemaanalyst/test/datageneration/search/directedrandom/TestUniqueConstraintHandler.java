...
import org.schemaanalyst.datageneration.search.directedrandom.UniqueConstraintHandler;
...
public class TestUniqueConstraintHandler {
    ...
    public void test(Integer[] dataValues,
        ...
        UniqueConstraintObjectiveFunction objFun = new UniqueConstraintObjectiveFunction(
                Collections.singletonList(database.column), 
                database.state, 
                "", goalIsToSatisfy, allowNull);
        
        UniqueConstraintHandler uch = new UniqueConstraintHandler(
