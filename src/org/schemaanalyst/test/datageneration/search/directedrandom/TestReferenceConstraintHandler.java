...
import org.schemaanalyst.datageneration.search.directedrandom.ReferenceConstraintHandler;
...
public class TestReferenceConstraintHandler {
    ...
    public void test(Integer[] dataValues,
        ...
        ReferenceConstraintHandler rch = new ReferenceConstraintHandler(objFun, random, cellRandomiser);
