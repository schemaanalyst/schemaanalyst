...
public class TestRelationalPredicateAnalyst {
	...
	public void testNotSatisfying() {
		...
		RelationalPredicate<Operand> rp 
				= new RelationalPredicate<Operand>(column, "<", new NumericValue(20));
		
		RelationalPredicateAnalyst rpa 
				= new RelationalPredicateAnalyst(rp, table, true);
	...
	public void testSatisfying() {
		...
		RelationalPredicate<Operand> rp 
				= new RelationalPredicate<Operand>(column, ">", new NumericValue(5));
