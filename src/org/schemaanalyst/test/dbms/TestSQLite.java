package org.schemaanalyst.test.dbms;
...
public class TestSQLite extends TestDBMS {
    ...
    public void singleColumnPrimaryKeyConstraintTest() {
        boolean[] results = {
                true, // 0. INSERT INTO t1 (c1) VALUES (NULL)
                true, // 1. INSERT INTO t1 (c1) VALUES (NULL)
        ...
        boolean[] integerResults = {
                true,  // 0. INSERT INTO t1 (c1) VALUES (NULL)
                true,  // 1. INSERT INTO t1 (c1) VALUES (NULL)
                false, // 2. INSERT INTO t1 (c1) VALUES (VAL) -- fails since NULL from previous statement has already inserted 1 as a value.
                false  // 3. INSERT INTO t1 (c1) VALUES (VAL)
        };
