 ...
 */
public class TestHyperSQL extends AbstractTestDBMS {
    ...
    public DatabaseInteractor getDatabaseInteractor() {
        if (databaseInteractor == null) {
            DBMS hyperSQLDBMS = DBMSFactory.instantiate("HyperSQL");
            databaseInteractor = hyperSQLDBMS.getDatabaseInteractor(
                    "test",
