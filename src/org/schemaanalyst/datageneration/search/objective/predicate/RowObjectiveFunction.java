package org.schemaanalyst.datageneration.search.objective.predicate;
...
public class RowObjectiveFunction extends ObjectiveFunction<RelationalPredicate<List<Cell>>> {
	...
	public static ObjectiveValue compute(List<Cell> lhs, RelationalOperator op, List<Cell> rhs) {
		RowObjectiveFunction objFun = new RowObjectiveFunction();
