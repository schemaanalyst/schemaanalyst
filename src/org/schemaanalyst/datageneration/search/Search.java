...
public abstract class Search<T extends Duplicable<T>> {
	 ...
	 * @param objectiveFunction The objective function to be used to evaluate candidate
	...
	/**
	 * Performs the search.
	 * @param candidateSolution The candidateSolution to use as the basis for the search.
	 */
	public abstract void search(T candidateSolution);
	
	/**
	 * Performs an objective function evaluation.
	 * @return The objective value as a result of the objective function evaluation.
	 */
	...
	/**
	 * Returns the candidate solution with the best objective value found by the search so far.
	 * @return The candidate solution with the best objective value found by the search so far.
	 */
