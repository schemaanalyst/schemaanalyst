...
public class SpyLogParser {
    ...
    /**
     * Read in a file from filename and return a List of lines that can be
     * parsed further
     */
    ...
    /**
     * Determine if the relevant component is an important SQL String; we are
     * looking for INSERTS now.
     */
