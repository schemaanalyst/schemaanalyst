...
public class FullTransactedUpFrontSchemata extends Runner {

    private final static Logger LOGGER = Logger.getLogger(FullTransactedUpFrontSchemata.class.getName());
    /**
    ...
    public static void main(String[] args) {
        new FullTransactedUpFrontSchemata().run(args);
    }
