...
public class TransactedUpFrontSchemata extends Runner {

    private final static Logger LOGGER = Logger.getLogger(TransactedUpFrontSchemata.class.getName());
    /**
    ...
    public static void main(String[] args) {
        new TransactedUpFrontSchemata().run(args);
    }
