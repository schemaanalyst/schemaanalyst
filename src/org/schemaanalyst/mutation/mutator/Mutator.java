 ...
 * 
 * @param <A>
 *            the type of the artefact being mutated.
 * @param <C>
...
public abstract class Mutator<A, C> {
	 ...
	 * 
	 * @param supplier
	 *            the supplier of duplicate artefacts and components for this
	 *            mutator.
	 */
	 ...
	 * 
	 * @param componentFromOriginalArtefact
	 *            the component from the original artefact.
	 */
