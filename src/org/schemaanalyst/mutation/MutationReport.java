...
public class MutationReport {
    ...
    /**
     * The file connected to the report on the file system and used for
     * reloading
     */
    ...
    /**
     * Initialize the file for reloading the report. NOTE: for some reason, this
     * could not go into the same method as was used for report loading. It made
     * reading into a blank file.
     */
