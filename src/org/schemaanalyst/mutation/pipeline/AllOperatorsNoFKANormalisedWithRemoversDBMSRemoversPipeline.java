 ...
 * mutants using the DBMS. This has the following properties:
 * <p><ul>
 ...
 */
public class AllOperatorsNoFKANormalisedWithRemoversDBMSRemoversPipeline extends MutationPipeline<Schema> {

    private static final Logger LOGGER = Logger.getLogger(AllOperatorsNoFKANormalisedWithRemoversDBMSRemoversPipeline.class.getName());
    private final Schema schema;

    public AllOperatorsNoFKANormalisedWithRemoversDBMSRemoversPipeline(Schema schema) {
        this.schema = schema;
