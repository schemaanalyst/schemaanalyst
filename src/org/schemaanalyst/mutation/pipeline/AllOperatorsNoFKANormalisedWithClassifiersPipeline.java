...
/**
 * A mutation pipeline with all operators except FKA and classifiers for 
 * equivalent and redundant mutants, with schema normalisation. This has the 
 ...
 */
public class AllOperatorsNoFKANormalisedWithClassifiersPipeline extends MutationPipeline<Schema> {

    private static final Logger LOGGER = Logger.getLogger(AllOperatorsNoFKANormalisedWithClassifiersPipeline.class.getName());
    private final Schema schema;

    public AllOperatorsNoFKANormalisedWithClassifiersPipeline(Schema schema) {
        this.schema = schema;
