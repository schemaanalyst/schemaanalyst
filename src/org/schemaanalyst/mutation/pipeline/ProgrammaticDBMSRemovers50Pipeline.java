 ...
 */
public class ProgrammaticDBMSRemovers50Pipeline extends MutationPipeline<Schema> {
    
    private static final Logger LOGGER = Logger.getLogger(ProgrammaticDBMSRemovers50Pipeline.class.getName());
