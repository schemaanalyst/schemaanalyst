 ...
 * and redundant mutants, with schema normalisation. This has the following 
 * properties:
 * <p><ul>
 ...
 */
public class AllOperatorsNoFKANormalisedWithRemoversPipeline extends MutationPipeline<Schema> {

    private static final Logger LOGGER = Logger.getLogger(AllOperatorsNoFKANormalisedWithRemoversPipeline.class.getName());
    private final Schema schema;

    public AllOperatorsNoFKANormalisedWithRemoversPipeline(Schema schema) {
        this.schema = schema;
