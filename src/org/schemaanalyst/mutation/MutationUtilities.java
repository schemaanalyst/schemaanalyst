...
public class MutationUtilities {
    ...
    /** Strip off the prefix from the name of a case study, helpful for producing better formatting graphs in R */
    ...
    /** Strip off the prefix and and suffix from the name of a case study, helpful for producing better formatting graphs in R */
