package org.schemaanalyst.coverage.testgeneration.datageneration.valuegeneration;
...
public class CellValueGenerator {
    ...
    private boolean addGeneratedValuesToLibrary;
    ...
    public CellValueGenerator(
            ...
            boolean addGeneratedValuesToLibrary) {
        ...
        this.addGeneratedValuesToLibrary = addGeneratedValuesToLibrary;
    }
    ...
    protected void generateRandomValue(Cell cell) {
        ...
        if (addGeneratedValuesToLibrary) {
            valueLibrary.addValue(cell.getValue());
        }
    }
}
