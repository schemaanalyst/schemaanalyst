...
import org.schemaanalyst.coverage.search.cellinitialization.CellInitializer;
import org.schemaanalyst.data.*;
import org.schemaanalyst.datageneration.search.Search;
import org.schemaanalyst.datageneration.search.objective.ObjectiveValue;
import org.schemaanalyst.util.random.Random;

public class AlternatingValueSearch extends Search<Row> {
    ...
    @Override
    public void search(Row row) {
        // set up
        this.row = row;
        cells = row.getCells();

        // start
        startInitialiser.initialize(cells);
        lastObjVal = null;
        evaluate();
    ...
    protected boolean evaluate() {
        ObjectiveValue nextObjVal = evaluate(row);
