...
public class NotNullConstraint extends Constraint {
     ...
     *
     * @param targetTable The table to copy the constraint to (must have a
    ...
    /**
     * Checks whether this NotNull instance is equal to another object. The
     * comparison compares the column only and ignores the constraint's name.
     *
