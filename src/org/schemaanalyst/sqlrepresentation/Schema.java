...
public class Schema extends IdentifiableEntity implements Serializable,
	 ...
	 *            the expression underpinning the constraint.
	 */
	public CheckConstraint createCheckConstraint(String name,
			Table table, Expression expression) {
		CheckConstraint checkConstraint = new CheckConstraint(name,
				table, expression);
		addCheckConstraint(checkConstraint);
		return checkConstraint;
	}
	...
	public ForeignKeyConstraint createForeignKeyConstraint(
			String name, Table table, List<Column> columns,
			Table referenceTable, List<Column> referenceColumns) {
		ForeignKeyConstraint foreignKeyConstraint = new ForeignKeyConstraint(
				name, table, columns, referenceTable,
				referenceColumns);
		addForeignKeyConstraint(foreignKeyConstraint);
		return foreignKeyConstraint;
	}
	 ...
	 */
	public ForeignKeyConstraint createForeignKeyConstraint(
			String name, Table table, Column column,
	...
	public PrimaryKeyConstraint createPrimaryKeyConstraint(
			String name, Table table, Column... columns) {
		PrimaryKeyConstraint primaryKeyConstraint = new PrimaryKeyConstraint(
				name, table, columns);
		setPrimaryKeyConstraint(primaryKeyConstraint);
		return primaryKeyConstraint;
	...
	public void removePrimaryKeyConstraint(Table table) {
		...
		ListIterator<PrimaryKeyConstraint> iterator = primaryKeyConstraints.listIterator();
