...
public class Schema extends IdentifiableEntity implements Serializable {
     ...
     *
     * @param constraint the <tt>CHECK</tt> constraint to be added.
     */
     ...
     *
     * @param constraint the <tt>CHECK</tt> constraint to remove.
     ...
     *
     * @param table the table on which the constraint is to be applied.
     * @param column the column of this table that is the subject of the
     * <tt>FOREIGN KEY</tt>.
     ...
     * @param name the name of the constraint.
     * @param table the table on which the constraint is to be applied.
     * @param columns the list of columns that are the subject of the
     * <tt>FOREIGN KEY</tt>.
     * @param referenceTable the table being referenced.
     ...
     * @param name the name of the constraint.
     * @param table the table on which the constraint is to be applied.
     * @param column the column of this table that is the subject of the FOREIGN
     * KEY.
     * @param referenceTable the table being referenced.
     * @param referenceColumn the column in the reference table.
     */
     ...
     *
     * @param constraint The <tt>FOREIGN KEY</tt> constraint to be added.
     */
     ...
     *
     * @param constraint the foreign key to remove.
     ...
     *
     * @param constraint the <tt>NOT NULL</tt> constraint to add.
     */
     ...
     *
     * @param columns the <tt>PRIMARY KEY</tt> columns.
     ...
     *
     * @param constraint The <tt>PRIMARY KEY</tt> for the table.
     */
     ...
     *
     * @param table The table whose <tt>PRIMARY KEY</tt> is to be removed.
     */
     ...
     *
     * @param table the table whose <tt>PRIMARY KEY</tt> is sought.
     ...
     *
     * @param table the table on which the constraint is to be applied.
     * @param columns the <tt>UNIQUE</tt> columns.
     ...
     *
     * @param constraint The <tt>UNIQUE</tt> constraint to be added.
     */
     ...
     *
     * @param constraint the unique constraint to be removed.
    ...
    public boolean removeUniqueConstraint(UniqueConstraint constraint) {
        boolean found = false;
        for (Iterator<UniqueConstraint> iter = uniqueConstraints.iterator(); iter.hasNext();) {
     ...
     *
     * @param table the table for which the constraints are required.
     * @param constraintSet the set from which to take the constraints from for
     * the table.
