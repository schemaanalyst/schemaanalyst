...
public class SchemaAnalyst {
    ...
    /** 
     * Save the information about the execution times of test data generation and mutation analysis.
     */
    ...
    /** 
     * Save the information about the purpose of an insert and whether it killed or not.
     */
    ...
    /** 
     * Save the mutant type information into the report in a non-redundant fashion.
     */
    ...
    /** 
     * Save the mutation score with a special format, currently the method chosen for storing the data. 
     */
    ...
    /** 
     * Save the mutation scores into the report in a redundant fashion that eases data analysis and visualization.
     */
    ...
    /** 
     * Save the mutation scores into the report in the standard, non-redundant fashion.
     */
    ...
    /**
     * Add all of the parameters to the experimental results -- these will be written out to the data file.
     */
