-- 8
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFERED_DEPT, DEPT_ID) with Pair(COURSE_ID, DEPT_ID)
...
CREATE TABLE "COURSE_INFO" (
	"COURSE_ID"	INT	PRIMARY KEY	 REFERENCES "DEPT_INFO" ("DEPT_ID")	NOT NULL,
