-- 19
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(OFFICE_ID, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"OFFICE_ID"	INT	 REFERENCES "OFFICE_INFO" ("OFFICE_ID")	 REFERENCES "RACE_INFO" ("RACE_CODE"),
	"GRADUATE"	SMALLINT,
	"RACE"	INT,
