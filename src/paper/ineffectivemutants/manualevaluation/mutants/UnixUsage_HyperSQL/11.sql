-- 11
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(GRADUATE, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
