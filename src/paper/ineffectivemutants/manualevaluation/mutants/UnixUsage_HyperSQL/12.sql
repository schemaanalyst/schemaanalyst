-- 12
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(RACE, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT,
	"RACE"	INT	 REFERENCES "RACE_INFO" ("RACE_CODE")	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
