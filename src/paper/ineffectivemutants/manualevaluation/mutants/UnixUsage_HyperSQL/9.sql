-- 9
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFERED_DEPT, DEPT_ID) with Pair(GRADUATE_LEVEL, DEPT_ID)
...
CREATE TABLE "COURSE_INFO" (
	...
	"OFFERED_DEPT"	INT,
	"GRADUATE_LEVEL"	SMALLINT	 REFERENCES "DEPT_INFO" ("DEPT_ID")
)
