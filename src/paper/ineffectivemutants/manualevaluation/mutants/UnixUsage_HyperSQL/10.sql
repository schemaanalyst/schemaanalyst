-- 10
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(OFFICE_ID, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT,
	"OFFICE_ID"	INT	 REFERENCES "OFFICE_INFO" ("OFFICE_ID")	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
	"GRADUATE"	SMALLINT,
