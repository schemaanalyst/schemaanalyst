-- 15
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(GRADUATE, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"OFFICE_ID"	INT,
	"GRADUATE"	SMALLINT	 REFERENCES "OFFICE_INFO" ("OFFICE_ID"),
