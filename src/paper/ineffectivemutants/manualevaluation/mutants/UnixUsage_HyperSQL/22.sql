-- 22
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(COURSE_ID, COURSE_ID) with Pair(SCORE, COURSE_ID)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"SCORE"	INT	 REFERENCES "COURSE_INFO" ("COURSE_ID"),
