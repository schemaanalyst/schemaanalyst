-- 29
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged TNUM1 with TCHAR
...
CREATE TABLE "TEST12649" (
	...
	CONSTRAINT "CND12649A" PRIMARY KEY ("TCHAR", "TNUM2"),
