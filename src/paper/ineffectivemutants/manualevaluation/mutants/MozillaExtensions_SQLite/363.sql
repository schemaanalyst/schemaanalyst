-- 363
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with minVersion
...
CREATE TABLE "targetApplication" (
	...
	"minVersion"	TEXT,
	"maxVersion"	TEXT,
	UNIQUE ("addon_internal_id", "minVersion")
)
