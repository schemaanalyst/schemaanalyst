-- 358
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged syncGUID with strictCompatibility
...
CREATE TABLE "addon" (
	...
	"strictCompatibility"	INT	UNIQUE,
	UNIQUE ("id", "location")
)
