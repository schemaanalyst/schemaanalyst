-- 206
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added pendingUninstall
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "pendingUninstall")
)
