-- 6
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added internalName
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "internalName"),
	UNIQUE ("id", "location")
)
