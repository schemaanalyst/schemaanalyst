-- 19
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added pendingUninstall
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "pendingUninstall"),
	UNIQUE ("id", "location")
)
