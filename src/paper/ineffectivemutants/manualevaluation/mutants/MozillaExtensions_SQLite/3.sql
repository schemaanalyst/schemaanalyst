-- 3
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added location
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "location"),
	UNIQUE ("id", "location")
)
