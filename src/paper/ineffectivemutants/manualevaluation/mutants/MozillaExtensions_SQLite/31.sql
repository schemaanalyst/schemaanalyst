-- 31
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added hasBinaryComponents
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "hasBinaryComponents"),
	UNIQUE ("id", "location")
)
