-- 193
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added internalName
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "internalName")
)
