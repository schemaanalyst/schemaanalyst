-- 22
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added updateDate
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "updateDate"),
	UNIQUE ("id", "location")
)
