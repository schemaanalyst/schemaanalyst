-- 10
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added optionsType
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "optionsType"),
	UNIQUE ("id", "location")
)
