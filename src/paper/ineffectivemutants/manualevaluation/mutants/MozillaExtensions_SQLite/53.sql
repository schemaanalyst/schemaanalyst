-- 53
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged internal_id with syncGUID

CREATE TABLE "addon" (
	"internal_id"	INT,
	"id"	TEXT,
	"syncGUID"	TEXT	PRIMARY KEY	UNIQUE,
	"location"	TEXT,
	"version"	TEXT,
	"type"	TEXT,
	"internalName"	TEXT,
