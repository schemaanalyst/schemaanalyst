-- 20
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added descriptor
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "descriptor"),
	UNIQUE ("id", "location")
)
