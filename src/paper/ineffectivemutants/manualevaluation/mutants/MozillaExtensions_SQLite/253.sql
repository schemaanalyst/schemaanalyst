-- 253
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added minVersion
...
CREATE TABLE "targetApplication" (
	...
	"minVersion"	TEXT,
	"maxVersion"	TEXT,
	UNIQUE ("addon_internal_id", "id", "minVersion")
)
