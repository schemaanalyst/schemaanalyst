-- 215
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added releaseNotesURI
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "releaseNotesURI")
)
