-- 16
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added active
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "active"),
	UNIQUE ("id", "location")
)
