-- 47
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added addon_internal_id
...
CREATE TABLE "targetPlatform" (
	"addon_internal_id"	INT	PRIMARY KEY,
	"os"	TEXT,
	"abi"	TEXT,
