-- 210
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added applyBackgroundUpdates
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "applyBackgroundUpdates")
)
