-- 291
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with releaseNotesURI
...
CREATE TABLE "addon" (
	...
	UNIQUE ("releaseNotesURI", "location")
)
