-- 83
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged internal_id with strictCompatibility
...
CREATE TABLE "addon" (
	...
	"strictCompatibility"	INT	PRIMARY KEY,
	UNIQUE ("id", "location")
)
