-- 8
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added updateKey
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "updateKey"),
	UNIQUE ("id", "location")
)
