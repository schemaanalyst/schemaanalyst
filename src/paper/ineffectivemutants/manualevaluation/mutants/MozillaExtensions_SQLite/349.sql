-- 349
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged syncGUID with applyBackgroundUpdates
...
CREATE TABLE "addon" (
	...
	"installDate"	INT,
	"updateDate"	INT,
	"applyBackgroundUpdates"	INT	UNIQUE,
	"bootstrap"	INT,
	"skinnable"	INT,
	"size"	INT,
	"sourceURI"	TEXT,
