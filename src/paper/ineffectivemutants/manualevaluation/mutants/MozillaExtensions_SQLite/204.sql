-- 204
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added userDisabled
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "userDisabled")
)
