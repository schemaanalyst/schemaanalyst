-- 12
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added iconURL
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "iconURL"),
	UNIQUE ("id", "location")
)
