-- 295
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with strictCompatibility
...
CREATE TABLE "addon" (
	...
	UNIQUE ("strictCompatibility", "location")
)
