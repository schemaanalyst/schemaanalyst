-- 205
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added appDisabled
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "appDisabled")
)
