-- 25
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added skinnable
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "skinnable"),
	UNIQUE ("id", "location")
)
