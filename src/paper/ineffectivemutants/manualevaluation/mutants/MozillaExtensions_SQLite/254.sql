-- 254
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added maxVersion
...
CREATE TABLE "targetApplication" (
	...
	"minVersion"	TEXT,
	"maxVersion"	TEXT,
	UNIQUE ("addon_internal_id", "id", "maxVersion")
)
