-- 74
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged internal_id with applyBackgroundUpdates

CREATE TABLE "addon" (
	"internal_id"	INT,
	"id"	TEXT,
	"syncGUID"	TEXT	UNIQUE,
	"location"	TEXT,
	"version"	TEXT,
	"type"	TEXT,
	"internalName"	TEXT,
	...
	"installDate"	INT,
	"updateDate"	INT,
	"applyBackgroundUpdates"	INT	PRIMARY KEY,
	"bootstrap"	INT,
	"skinnable"	INT,
	"size"	INT,
	"sourceURI"	TEXT,
	"releaseNotesURI"	TEXT,
	"softDisabled"	INT,
