-- 218
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added hasBinaryComponents
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "hasBinaryComponents")
)
