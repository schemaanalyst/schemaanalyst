-- 217
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added isForeignInstall
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "isForeignInstall")
)
