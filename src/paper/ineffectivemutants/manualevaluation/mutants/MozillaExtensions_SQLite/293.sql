-- 293
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with isForeignInstall
...
CREATE TABLE "addon" (
	...
	UNIQUE ("isForeignInstall", "location")
)
