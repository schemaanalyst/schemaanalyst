-- 197
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added optionsType
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "optionsType")
)
