-- 286
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with applyBackgroundUpdates
...
CREATE TABLE "addon" (
	...
	UNIQUE ("applyBackgroundUpdates", "location")
)
