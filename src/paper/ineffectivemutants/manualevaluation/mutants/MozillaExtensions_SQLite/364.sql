-- 364
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with maxVersion
...
CREATE TABLE "targetApplication" (
	...
	"minVersion"	TEXT,
	"maxVersion"	TEXT,
	UNIQUE ("addon_internal_id", "maxVersion")
)
