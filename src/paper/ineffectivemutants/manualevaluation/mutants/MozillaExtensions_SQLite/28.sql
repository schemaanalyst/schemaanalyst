-- 28
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added releaseNotesURI
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "releaseNotesURI"),
	UNIQUE ("id", "location")
)
