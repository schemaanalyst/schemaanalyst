-- 252
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added locale_id
...
CREATE TABLE "addon_locale" (
	...
	"locale"	TEXT,
	"locale_id"	INT,
	UNIQUE ("addon_internal_id", "locale", "locale_id")
)
