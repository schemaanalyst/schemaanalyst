-- 360
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged locale with locale_id
...
CREATE TABLE "addon_locale" (
	...
	"locale"	TEXT,
	"locale_id"	INT,
	UNIQUE ("addon_internal_id", "locale_id")
)
