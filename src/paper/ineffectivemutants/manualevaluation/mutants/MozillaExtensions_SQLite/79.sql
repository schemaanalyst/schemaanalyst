-- 79
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged internal_id with releaseNotesURI
...
CREATE TABLE "addon" (
	...
	"size"	INT,
	"sourceURI"	TEXT,
	"releaseNotesURI"	TEXT	PRIMARY KEY,
	"softDisabled"	INT,
