-- 201
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added defaultLocale
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "defaultLocale")
)
