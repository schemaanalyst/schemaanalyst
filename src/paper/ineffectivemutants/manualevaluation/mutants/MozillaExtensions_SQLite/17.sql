-- 17
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added userDisabled
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "userDisabled"),
	UNIQUE ("id", "location")
)
