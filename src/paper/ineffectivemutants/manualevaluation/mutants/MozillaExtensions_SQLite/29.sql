-- 29
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added softDisabled
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "softDisabled"),
	UNIQUE ("id", "location")
)
