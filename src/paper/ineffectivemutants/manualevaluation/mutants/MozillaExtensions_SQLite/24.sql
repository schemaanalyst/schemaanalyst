-- 24
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added bootstrap
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "bootstrap"),
	UNIQUE ("id", "location")
)
