-- 208
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added installDate
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "installDate")
)
