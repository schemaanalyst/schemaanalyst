-- 7
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added updateURL
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "updateURL"),
	UNIQUE ("id", "location")
)
