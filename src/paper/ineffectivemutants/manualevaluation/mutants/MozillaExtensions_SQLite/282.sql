-- 282
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged id with pendingUninstall
...
CREATE TABLE "addon" (
	...
	UNIQUE ("pendingUninstall", "location")
)
