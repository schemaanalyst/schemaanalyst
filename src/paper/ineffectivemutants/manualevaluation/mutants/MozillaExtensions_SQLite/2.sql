-- 2
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added syncGUID
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "syncGUID"),
	UNIQUE ("id", "location")
)
