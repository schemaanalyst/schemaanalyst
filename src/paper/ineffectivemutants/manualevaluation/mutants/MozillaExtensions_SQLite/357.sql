-- 357
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged syncGUID with hasBinaryComponents
...
CREATE TABLE "addon" (
	...
	"hasBinaryComponents"	INT	UNIQUE,
