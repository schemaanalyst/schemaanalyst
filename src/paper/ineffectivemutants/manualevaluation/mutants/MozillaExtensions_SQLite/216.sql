-- 216
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added softDisabled
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "location", "softDisabled")
)
