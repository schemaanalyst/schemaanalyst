-- 13
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added icon64URL
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "icon64URL"),
	UNIQUE ("id", "location")
)
