-- 327
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged syncGUID with internal_id

CREATE TABLE "addon" (
	"internal_id"	INT	PRIMARY KEY	UNIQUE,
	"id"	TEXT,
	"syncGUID"	TEXT,
	"location"	TEXT,
	"version"	TEXT,
