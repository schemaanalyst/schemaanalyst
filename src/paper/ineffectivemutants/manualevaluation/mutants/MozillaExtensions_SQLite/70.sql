-- 70
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged internal_id with pendingUninstall
...
CREATE TABLE "addon" (
	...
	"userDisabled"	INT,
	"appDisabled"	INT,
	"pendingUninstall"	INT	PRIMARY KEY,
	"descriptor"	TEXT,
	"installDate"	INT,
	"updateDate"	INT,
