-- 18
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added appDisabled
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "appDisabled"),
	UNIQUE ("id", "location")
)
