-- 30
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added isForeignInstall
...
CREATE TABLE "addon" (
	...
	PRIMARY KEY ("internal_id", "isForeignInstall"),
	UNIQUE ("id", "location")
)
