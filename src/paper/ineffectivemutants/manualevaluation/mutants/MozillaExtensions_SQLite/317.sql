-- 317
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged location with applyBackgroundUpdates
...
CREATE TABLE "addon" (
	...
	UNIQUE ("id", "applyBackgroundUpdates")
)
