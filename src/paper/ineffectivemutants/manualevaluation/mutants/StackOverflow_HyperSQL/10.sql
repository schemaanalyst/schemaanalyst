-- 10
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added accepted_answer_id
...
CREATE TABLE "posts" (
	...
	"parent_id"	INT,
	"accepted_answer_id"	INT	PRIMARY KEY,
	"creation_date"	DATE,
	"score"	SMALLINT,
	"view_count"	INT,
	"body"	LONGVARCHAR,
