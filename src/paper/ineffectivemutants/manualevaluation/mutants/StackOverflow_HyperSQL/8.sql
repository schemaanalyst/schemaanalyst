-- 8
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added post_type_id
...
CREATE TABLE "posts" (
	"id"	INT	NOT NULL,
	"post_type_id"	SMALLINT	PRIMARY KEY,
	"parent_id"	INT,
