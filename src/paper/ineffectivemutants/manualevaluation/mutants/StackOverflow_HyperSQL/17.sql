-- 17
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added last_editor_display_name
...
CREATE TABLE "posts" (
	...
	"last_editor_display_name"	LONGVARCHAR	PRIMARY KEY,
	"last_edit_date"	DATE,
