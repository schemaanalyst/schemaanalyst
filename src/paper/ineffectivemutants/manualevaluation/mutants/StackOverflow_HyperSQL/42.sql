-- 42
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added vote_type_id
...
CREATE TABLE "votes" (
	...
	"vote_type_id"	SMALLINT	PRIMARY KEY,
	"creation_date"	DATE
)
