-- 20
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added community_owned_date
...
CREATE TABLE "posts" (
	...
	"community_owned_date"	DATE	PRIMARY KEY,
	"closed_date"	DATE,
	"title"	LONGVARCHAR,
	"tags"	LONGVARCHAR,
