-- 30
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added display_name
...
CREATE TABLE "users" (
	...
	"reputation"	INT,
	"creation_date"	DATE,
	"display_name"	LONGVARCHAR	PRIMARY KEY,
