-- 36
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added about_me
...
CREATE TABLE "users" (
	...
	"age"	SMALLINT,
	"about_me"	LONGVARCHAR	PRIMARY KEY,
	"views"	INT,
	"up_votes"	INT,
	"down_votes"	INT
)
