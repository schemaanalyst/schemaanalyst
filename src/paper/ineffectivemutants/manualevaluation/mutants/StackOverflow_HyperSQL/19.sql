-- 19
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added last_activity_date
...
CREATE TABLE "posts" (
	...
	"last_edit_date"	DATE,
	"last_activity_date"	DATE	PRIMARY KEY,
