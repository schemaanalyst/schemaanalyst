-- 26
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added favorite_count
...
CREATE TABLE "posts" (
	...
	"favorite_count"	INT	PRIMARY KEY
)
