-- 86
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged isbn with stock
...
CREATE TABLE "stock" (
	...
	"cost"	NUMERIC(5, 2),
	"retail"	NUMERIC(5, 2),
	"stock"	INT	CONSTRAINT "stock_pkey" PRIMARY KEY
)
