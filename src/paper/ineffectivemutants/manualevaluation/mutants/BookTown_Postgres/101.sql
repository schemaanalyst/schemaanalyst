-- 101
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged employee_id with schedule
...
CREATE TABLE "schedules" (
	...
	"schedule"	VARCHAR(100)	CONSTRAINT "schedules_pkey" PRIMARY KEY
)
