-- 24
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added money_cash
...
CREATE TABLE "money_example" (
	"money_cash"	NUMERIC(6, 2)	PRIMARY KEY,
