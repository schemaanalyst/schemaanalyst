-- 29
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added ship_date
...
CREATE TABLE "shipments" (
	...
	"customer_id"	INT,
	"isbn"	VARCHAR(100),
	"ship_date"	TIMESTAMP	PRIMARY KEY
)
