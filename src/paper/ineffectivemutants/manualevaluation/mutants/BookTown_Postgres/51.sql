-- 51
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added award
...
CREATE TABLE "distinguished_authors" (
	...
	"first_name"	VARCHAR(100),
	"award"	VARCHAR(100),
	CONSTRAINT "distinguished_authors_pkey" PRIMARY KEY ("id", "award")
)
