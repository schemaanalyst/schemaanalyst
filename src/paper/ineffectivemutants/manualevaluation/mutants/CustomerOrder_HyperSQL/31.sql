-- 31
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with order_id
...
CREATE TABLE "db_order_item" (
	"id"	INT	NOT NULL,
	"order_id"	INT	PRIMARY KEY	CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("id")	NOT NULL,
