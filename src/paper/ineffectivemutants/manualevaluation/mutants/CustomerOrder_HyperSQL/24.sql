-- 24
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(order_id, id) with Pair(number_of_items, id)
...
CREATE TABLE "db_order_item" (
	...
	"number_of_items"	INT	CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("id")	NOT NULL,
