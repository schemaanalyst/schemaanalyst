-- 22
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(customer_id, id) with Pair(total_price, id)
...
CREATE TABLE "db_order" (
	...
	"total_price"	DECIMAL(8, 2)	CONSTRAINT "db_order_customer_fk"  REFERENCES "db_customer" ("id")	NOT NULL,
