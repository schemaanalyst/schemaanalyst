-- 25
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(order_id, id) with Pair(total_price, id)
...
CREATE TABLE "db_order_item" (
    ...
    "total_price"   DECIMAL(8, 2)   CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("id")   NOT NULL
)
