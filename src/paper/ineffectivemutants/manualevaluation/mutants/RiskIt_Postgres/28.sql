-- 28
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(EMPLOYERSIZE, INDUSTRYCODE)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT	 REFERENCES "industry" ("INDUSTRYCODE"),
	"WEEKWAGE"	INT,
