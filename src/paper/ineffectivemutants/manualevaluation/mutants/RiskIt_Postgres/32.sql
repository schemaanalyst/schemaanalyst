-- 32
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(OCCUPATIONCODE, INDUSTRYCODE)
...
CREATE TABLE "wage" (
	...
	"OCCUPATIONCODE"	INT	 REFERENCES "occupation" ("OCCUPATIONCODE")	 REFERENCES "industry" ("INDUSTRYCODE")	NOT NULL,
	"MEANWEEKWAGE"	INT,
