-- 92
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with MIGRATIONFROMSUNBELT
...
CREATE TABLE "migration" (
	...
	"MIGRATIONFROMSUNBELT"	CHAR(50)	PRIMARY KEY
)
