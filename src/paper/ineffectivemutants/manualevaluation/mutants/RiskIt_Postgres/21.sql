-- 21
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(OCCUPATIONCODE, SSN)
...
CREATE TABLE "job" (
	...
	"OCCUPATIONCODE"	INT	 REFERENCES "occupation" ("OCCUPATIONCODE")	 REFERENCES "userrecord" ("SSN"),
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
