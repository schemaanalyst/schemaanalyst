-- 12
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(CAPITALLOSSES, SSN)
...
CREATE TABLE "investment" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"CAPITALGAINS"	INT,
	"CAPITALLOSSES"	INT	 REFERENCES "userrecord" ("SSN"),
	"STOCKDIVIDENDS"	INT
)
