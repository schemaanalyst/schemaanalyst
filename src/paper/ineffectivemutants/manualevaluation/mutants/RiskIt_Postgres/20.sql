-- 20
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(INDUSTRYCODE, SSN)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"WORKCLASS"	CHAR(50),
	"INDUSTRYCODE"	INT	 REFERENCES "industry" ("INDUSTRYCODE")	 REFERENCES "userrecord" ("SSN"),
