-- 11
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(CAPITALGAINS, SSN)
...
CREATE TABLE "investment" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"CAPITALGAINS"	INT	 REFERENCES "userrecord" ("SSN"),
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT
)
