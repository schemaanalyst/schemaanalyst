-- 89
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with MIGRATIONCODE
...
CREATE TABLE "migration" (
	...
	"MIGRATIONCODE"	CHAR(50)	PRIMARY KEY,
