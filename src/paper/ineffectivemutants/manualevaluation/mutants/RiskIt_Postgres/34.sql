-- 34
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(INDUSTRYCODE, OCCUPATIONCODE)
...
CREATE TABLE "wage" (
	"INDUSTRYCODE"	INT	 REFERENCES "industry" ("INDUSTRYCODE")	 REFERENCES "occupation" ("OCCUPATIONCODE")	NOT NULL,
