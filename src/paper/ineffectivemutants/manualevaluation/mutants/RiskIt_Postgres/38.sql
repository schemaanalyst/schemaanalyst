-- 38
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added UNEMPLOYMENTREASON
...
CREATE TABLE "employmentstat" (
	...
	PRIMARY KEY ("SSN", "UNEMPLOYMENTREASON")
)
