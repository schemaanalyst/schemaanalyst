-- 24
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SELFEMPLOYED, SSN)
...
CREATE TABLE "job" (
	...
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
	"SELFEMPLOYED"	SMALLINT	 REFERENCES "userrecord" ("SSN"),
	"WORKWEEKS"	INT
)
