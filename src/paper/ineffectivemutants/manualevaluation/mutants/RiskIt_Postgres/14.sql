-- 14
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(SSN, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("SSN")	 REFERENCES "occupation" ("OCCUPATIONCODE")	NOT NULL,
	"WORKCLASS"	CHAR(50),
