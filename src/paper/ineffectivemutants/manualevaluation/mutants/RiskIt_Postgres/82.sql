-- 82
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with INDUSTRYCODE
...
CREATE TABLE "job" (
	...
	"WORKCLASS"	CHAR(50),
	"INDUSTRYCODE"	INT	PRIMARY KEY	 REFERENCES "industry" ("INDUSTRYCODE"),
