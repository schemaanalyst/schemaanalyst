-- 87
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with SELFEMPLOYED
...
CREATE TABLE "job" (
	...
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
	"SELFEMPLOYED"	SMALLINT	PRIMARY KEY,
	"WORKWEEKS"	INT
)
