-- 22
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(EMPLOYERSIZE, SSN)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT	 REFERENCES "userrecord" ("SSN"),
	"WEEKWAGE"	INT,
