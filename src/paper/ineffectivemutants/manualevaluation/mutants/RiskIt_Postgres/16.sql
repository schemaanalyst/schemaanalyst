-- 16
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(EMPLOYERSIZE, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	...
	"OCCUPATIONCODE"	INT,
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT	 REFERENCES "occupation" ("OCCUPATIONCODE"),
	"WEEKWAGE"	INT,
