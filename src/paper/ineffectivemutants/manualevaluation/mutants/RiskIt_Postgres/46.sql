-- 46
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added OCCUPATIONCODE
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	PRIMARY KEY ("SSN", "OCCUPATIONCODE")
)
