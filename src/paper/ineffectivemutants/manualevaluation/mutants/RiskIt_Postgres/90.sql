-- 90
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with MIGRATIONDISTANCE
...
CREATE TABLE "migration" (
	...
	"MIGRATIONDISTANCE"	CHAR(50)	PRIMARY KEY,
