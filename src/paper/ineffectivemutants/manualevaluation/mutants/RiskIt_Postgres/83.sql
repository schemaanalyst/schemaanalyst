-- 83
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with OCCUPATIONCODE
...
CREATE TABLE "job" (
	"SSN"	INT	 REFERENCES "userrecord" ("SSN")	NOT NULL,
	"WORKCLASS"	CHAR(50),
	"INDUSTRYCODE"	INT	 REFERENCES "industry" ("INDUSTRYCODE"),
	"OCCUPATIONCODE"	INT	PRIMARY KEY	 REFERENCES "occupation" ("OCCUPATIONCODE"),
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
