-- 35
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(MEANWEEKWAGE, OCCUPATIONCODE)
...
CREATE TABLE "wage" (
	...
	"MEANWEEKWAGE"	INT	 REFERENCES "occupation" ("OCCUPATIONCODE"),
