-- 39
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added EMPLOYMENTSTAT
...
CREATE TABLE "employmentstat" (
	...
	PRIMARY KEY ("SSN", "EMPLOYMENTSTAT")
)
