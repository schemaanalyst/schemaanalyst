-- 29
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(WEEKWAGE, INDUSTRYCODE)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT	 REFERENCES "industry" ("INDUSTRYCODE"),
