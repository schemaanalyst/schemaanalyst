-- 53
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added MIGRATIONDISTANCE
...
CREATE TABLE "migration" (
	...
	PRIMARY KEY ("SSN", "MIGRATIONDISTANCE")
)
