-- 13
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(STOCKDIVIDENDS, SSN)
...
CREATE TABLE "investment" (
	...
	"CAPITALGAINS"	INT,
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT	 REFERENCES "userrecord" ("SSN")
)
