-- 25
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(WORKWEEKS, SSN)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT	 REFERENCES "userrecord" ("SSN")
)
