-- 91
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with MIGRATIONMOVE
...
CREATE TABLE "migration" (
	...
	"MIGRATIONMOVE"	CHAR(50)	PRIMARY KEY,
