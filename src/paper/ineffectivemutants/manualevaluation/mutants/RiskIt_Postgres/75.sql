-- 75
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with UNEMPLOYMENTREASON
...
CREATE TABLE "employmentstat" (
	...
	"UNEMPLOYMENTREASON"	CHAR(50)	PRIMARY KEY,
