-- 26
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(SSN, INDUSTRYCODE)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("SSN")	 REFERENCES "industry" ("INDUSTRYCODE")	NOT NULL,
	"WORKCLASS"	CHAR(50),
	"INDUSTRYCODE"	INT,
