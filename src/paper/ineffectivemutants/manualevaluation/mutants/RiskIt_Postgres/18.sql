-- 18
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(SELFEMPLOYED, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	...
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
	"SELFEMPLOYED"	SMALLINT	 REFERENCES "occupation" ("OCCUPATIONCODE"),
	"WORKWEEKS"	INT
)
