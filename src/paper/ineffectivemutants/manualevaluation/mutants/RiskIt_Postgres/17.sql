-- 17
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(WEEKWAGE, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT	 REFERENCES "occupation" ("OCCUPATIONCODE"),
