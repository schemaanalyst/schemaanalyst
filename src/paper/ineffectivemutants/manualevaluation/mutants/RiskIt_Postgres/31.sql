-- 31
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(WORKWEEKS, INDUSTRYCODE)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT	 REFERENCES "industry" ("INDUSTRYCODE")
)
