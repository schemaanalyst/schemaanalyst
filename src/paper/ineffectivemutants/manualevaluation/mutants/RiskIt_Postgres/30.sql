-- 30
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(SELFEMPLOYED, INDUSTRYCODE)
...
CREATE TABLE "job" (
	...
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
	"SELFEMPLOYED"	SMALLINT	 REFERENCES "industry" ("INDUSTRYCODE"),
	"WORKWEEKS"	INT
)
