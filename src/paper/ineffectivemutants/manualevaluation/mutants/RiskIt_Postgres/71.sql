-- 71
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed OCCUPATIONCODE
...
CREATE TABLE "wage" (
	"INDUSTRYCODE"	INT	PRIMARY KEY	 REFERENCES "industry" ("INDUSTRYCODE")	NOT NULL,
