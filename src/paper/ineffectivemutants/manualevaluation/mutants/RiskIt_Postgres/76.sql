-- 76
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with EMPLOYMENTSTAT
...
CREATE TABLE "employmentstat" (
	...
	"EMPLOYMENTSTAT"	CHAR(50)	PRIMARY KEY
)
