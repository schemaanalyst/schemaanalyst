-- 110
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(category_id, id) with Pair(category_id, parent_id)
...
CREATE TABLE "db_product" (
	...
	"name"	VARCHAR(30)	NOT NULL,
	"category_id"	VARCHAR(9)	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("parent_id")	NOT NULL,
