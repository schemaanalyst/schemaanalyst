-- 83
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(order_id, description)
...
CREATE TABLE "db_order_item" (
	...
	"total_price"	DECIMAL(8, 2)	NOT NULL,
	CONSTRAINT "db_order_item_product_fk" FOREIGN KEY ("product_ean_code", "order_id") REFERENCES "db_product" ("ean_code", "description")
)
