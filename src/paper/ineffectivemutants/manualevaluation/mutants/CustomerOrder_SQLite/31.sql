-- 31
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(first_name, email)
...
CREATE TABLE "db_customer" (
	...
	"birth_date"	DATE,
	CONSTRAINT "db_customer_user_fk" FOREIGN KEY ("id", "first_name") REFERENCES "db_user" ("id", "email")
)
