-- 39
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(last_name, active)
...
CREATE TABLE "db_customer" (
	...
	"birth_date"	DATE,
	CONSTRAINT "db_customer_user_fk" FOREIGN KEY ("id", "last_name") REFERENCES "db_user" ("id", "active")
)
