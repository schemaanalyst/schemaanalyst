-- 205
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with customer_id
...
CREATE TABLE "db_order" (
	"id"	INT	NOT NULL,
	"customer_id"	INT	PRIMARY KEY	CONSTRAINT "db_order_customer_fk"  REFERENCES "db_customer" ("id")	NOT NULL,
