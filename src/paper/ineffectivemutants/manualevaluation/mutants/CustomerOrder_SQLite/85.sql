-- 85
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(number_of_items, category_id)
...
CREATE TABLE "db_order_item" (
	...
	"total_price"	DECIMAL(8, 2)	NOT NULL,
	CONSTRAINT "db_order_item_product_fk" FOREIGN KEY ("product_ean_code", "number_of_items") REFERENCES "db_product" ("ean_code", "category_id")
)
