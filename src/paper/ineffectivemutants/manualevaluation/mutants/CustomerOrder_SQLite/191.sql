-- 191
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ean_code with price
...
CREATE TABLE "db_product" (
	...
	"price"	DECIMAL(8, 2)	PRIMARY KEY	NOT NULL,
