-- 147
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(product_ean_code, ean_code) with Pair(number_of_items, ean_code)
...
CREATE TABLE "db_order_item" (
	...
	"number_of_items"	INT	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	NOT NULL,
