-- 137
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(customer_id, id) with Pair(created_at, id)
...
CREATE TABLE "db_order" (
	...
	"created_at"	TIMESTAMP	CONSTRAINT "db_order_customer_fk"  REFERENCES "db_customer" ("id")	NOT NULL
)
