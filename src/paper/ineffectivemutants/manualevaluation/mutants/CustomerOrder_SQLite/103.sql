-- 103
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(parent_id, id) with Pair(id, id)

CREATE TABLE "db_category" (
	"id"	VARCHAR(9)	PRIMARY KEY	CONSTRAINT "db_category_parent_fk"  REFERENCES "db_category" ("id")	NOT NULL,
