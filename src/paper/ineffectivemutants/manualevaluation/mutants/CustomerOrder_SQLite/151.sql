-- 151
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(product_ean_code, ean_code) with Pair(product_ean_code, manufacturer)
...
CREATE TABLE "db_order_item" (
	...
	"product_ean_code"	VARCHAR(13)	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("manufacturer")	NOT NULL,
	"total_price"	DECIMAL(8, 2)	NOT NULL
)
