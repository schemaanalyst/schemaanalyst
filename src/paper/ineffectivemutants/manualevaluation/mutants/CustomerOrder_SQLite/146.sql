-- 146
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(product_ean_code, ean_code) with Pair(order_id, ean_code)
...
CREATE TABLE "db_order_item" (
	"id"	INT	PRIMARY KEY	NOT NULL,
	"order_id"	INT	CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("id")	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	NOT NULL,
