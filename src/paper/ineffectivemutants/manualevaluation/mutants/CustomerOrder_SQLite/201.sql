-- 201
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with salutation
...
CREATE TABLE "db_customer" (
	"id"	INT	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id")	NOT NULL,
	"category"	CHAR(1)	NOT NULL,
	"salutation"	VARCHAR(10)	PRIMARY KEY,
