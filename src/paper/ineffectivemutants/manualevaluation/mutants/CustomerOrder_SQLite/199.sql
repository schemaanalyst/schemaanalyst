-- 199
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with active
...
CREATE TABLE "db_user" (
	...
	"active"	SMALLINT	PRIMARY KEY	NOT NULL,
