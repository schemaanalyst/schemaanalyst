-- 145
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(product_ean_code, ean_code) with Pair(id, ean_code)
...
CREATE TABLE "db_order_item" (
	"id"	INT	PRIMARY KEY	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	NOT NULL,
