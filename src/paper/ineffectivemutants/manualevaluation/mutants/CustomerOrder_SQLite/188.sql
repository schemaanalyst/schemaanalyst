-- 188
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with parent_id

CREATE TABLE "db_category" (
	"id"	VARCHAR(9)	NOT NULL,
	"name"	VARCHAR(30)	NOT NULL,
	"parent_id"	VARCHAR(9)	PRIMARY KEY	CONSTRAINT "db_category_parent_fk"  REFERENCES "db_category" ("id")
)
