-- 143
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(order_id, id) with Pair(product_ean_code, id)
...
CREATE TABLE "db_order_item" (
	...
	"product_ean_code"	VARCHAR(13)	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("id")	NOT NULL,
	"total_price"	DECIMAL(8, 2)	NOT NULL
)
