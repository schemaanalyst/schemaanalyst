-- 154
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(product_ean_code, ean_code) with Pair(total_price, ean_code)
...
CREATE TABLE "db_order_item" (
	...
	"total_price"	DECIMAL(8, 2)	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	NOT NULL
)
