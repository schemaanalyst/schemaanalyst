-- 126
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(salutation, id)
...
CREATE TABLE "db_customer" (
	...
	"salutation"	VARCHAR(10)	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id"),
