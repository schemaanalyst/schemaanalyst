-- 23
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(category, role_id)
...
CREATE TABLE "db_customer" (
	...
	"birth_date"	DATE,
	CONSTRAINT "db_customer_user_fk" FOREIGN KEY ("id", "category") REFERENCES "db_user" ("id", "role_id")
)
