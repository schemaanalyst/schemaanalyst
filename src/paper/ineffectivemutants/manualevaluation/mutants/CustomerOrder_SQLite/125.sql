-- 125
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(category, id)
...
CREATE TABLE "db_customer" (
	"id"	INT	PRIMARY KEY	NOT NULL,
	"category"	CHAR(1)	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id")	NOT NULL,
