-- 68
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(product_ean_code, created_at)
...
CREATE TABLE "db_order_item" (
	...
	"total_price"	DECIMAL(8, 2)	NOT NULL,
	CONSTRAINT "db_order_item_order_fk" FOREIGN KEY ("order_id", "product_ean_code") REFERENCES "db_order" ("id", "created_at")
)
