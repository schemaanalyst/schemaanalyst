-- 45
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(id, category)
...
CREATE TABLE "db_order" (
	...
	CONSTRAINT "db_order_customer_fk" FOREIGN KEY ("customer_id", "id") REFERENCES "db_customer" ("id", "category")
)
