-- 50
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(total_price, category)
...
CREATE TABLE "db_order" (
	...
	CONSTRAINT "db_order_customer_fk" FOREIGN KEY ("customer_id", "total_price") REFERENCES "db_customer" ("id", "category")
)
