-- 211
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with total_price
...
CREATE TABLE "db_order_item" (
	...
	"total_price"	DECIMAL(8, 2)	PRIMARY KEY	NOT NULL
)
