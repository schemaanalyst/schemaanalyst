-- 190
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ean_code with category_id
...
CREATE TABLE "db_product" (
	...
	"name"	VARCHAR(30)	NOT NULL,
	"category_id"	VARCHAR(9)	PRIMARY KEY	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id")	NOT NULL,
