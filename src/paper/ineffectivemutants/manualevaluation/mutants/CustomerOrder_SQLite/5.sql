-- 5
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(id, parent_id)

CREATE TABLE "db_category" (
	"id"	VARCHAR(9)	PRIMARY KEY	NOT NULL,
	"name"	VARCHAR(30)	NOT NULL,
	"parent_id"	VARCHAR(9),
	CONSTRAINT "db_category_parent_fk" FOREIGN KEY ("parent_id", "id") REFERENCES "db_category" ("id", "parent_id")
)
