-- 112
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(category_id, id) with Pair(manufacturer, id)
...
CREATE TABLE "db_product" (
	...
	"manufacturer"	VARCHAR(30)	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id")	NOT NULL,
	"notes"	VARCHAR(256),
