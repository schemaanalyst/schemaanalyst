-- 140
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(order_id, id) with Pair(order_id, total_price)
...
CREATE TABLE "db_order_item" (
	"id"	INT	PRIMARY KEY	NOT NULL,
	"order_id"	INT	CONSTRAINT "db_order_item_order_fk"  REFERENCES "db_order" ("total_price")	NOT NULL,
