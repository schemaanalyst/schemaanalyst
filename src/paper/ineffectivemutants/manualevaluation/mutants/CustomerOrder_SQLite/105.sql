-- 105
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(parent_id, id) with Pair(parent_id, name)

CREATE TABLE "db_category" (
	"id"	VARCHAR(9)	PRIMARY KEY	NOT NULL,
	"name"	VARCHAR(30)	NOT NULL,
	"parent_id"	VARCHAR(9)	CONSTRAINT "db_category_parent_fk"  REFERENCES "db_category" ("name")
)
