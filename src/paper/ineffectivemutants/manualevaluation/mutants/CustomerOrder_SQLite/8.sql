-- 8
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ean_code, name)
...
CREATE TABLE "db_product" (
	...
	CONSTRAINT "db_product_category_fk" FOREIGN KEY ("category_id", "ean_code") REFERENCES "db_category" ("id", "name")
)
