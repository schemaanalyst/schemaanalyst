-- 115
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(role_id, name) with Pair(id, name)
...
CREATE TABLE "db_user" (
	"id"	INT	PRIMARY KEY	CONSTRAINT "db_user_role_fk"  REFERENCES "db_role" ("name")	NOT NULL,
	"name"	VARCHAR(30)	NOT NULL,
