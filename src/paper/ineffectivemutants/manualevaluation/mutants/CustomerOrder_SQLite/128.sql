-- 128
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(last_name, id)
...
CREATE TABLE "db_customer" (
	...
	"last_name"	VARCHAR(30)	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id")	NOT NULL,
	"birth_date"	DATE
)
