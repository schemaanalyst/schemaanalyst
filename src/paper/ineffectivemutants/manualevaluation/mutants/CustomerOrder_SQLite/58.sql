-- 58
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(created_at, last_name)
...
CREATE TABLE "db_order" (
	...
	CONSTRAINT "db_order_customer_fk" FOREIGN KEY ("customer_id", "created_at") REFERENCES "db_customer" ("id", "last_name")
)
