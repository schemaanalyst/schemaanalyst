-- 111
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(category_id, id) with Pair(price, id)
...
CREATE TABLE "db_product" (
	...
	"price"	DECIMAL(8, 2)	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id")	NOT NULL,
