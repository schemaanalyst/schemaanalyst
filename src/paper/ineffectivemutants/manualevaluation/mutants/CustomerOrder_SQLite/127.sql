-- 127
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(first_name, id)
...
CREATE TABLE "db_customer" (
	...
	"first_name"	VARCHAR(30)	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id")	NOT NULL,
