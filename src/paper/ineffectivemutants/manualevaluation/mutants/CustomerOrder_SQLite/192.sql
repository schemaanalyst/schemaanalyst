-- 192
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ean_code with manufacturer
...
CREATE TABLE "db_product" (
	...
	"manufacturer"	VARCHAR(30)	PRIMARY KEY	NOT NULL,
	"notes"	VARCHAR(256),
