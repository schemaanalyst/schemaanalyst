-- 131
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(customer_id, id) with Pair(customer_id, category)
...
CREATE TABLE "db_order" (
	"id"	INT	PRIMARY KEY	NOT NULL,
	"customer_id"	INT	CONSTRAINT "db_order_customer_fk"  REFERENCES "db_customer" ("category")	NOT NULL,
