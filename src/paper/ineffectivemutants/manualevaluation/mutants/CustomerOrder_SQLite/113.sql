-- 113
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(category_id, id) with Pair(notes, id)
...
CREATE TABLE "db_product" (
	...
	"notes"	VARCHAR(256)	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id"),
