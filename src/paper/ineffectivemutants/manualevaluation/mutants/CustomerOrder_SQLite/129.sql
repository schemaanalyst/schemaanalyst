-- 129
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(birth_date, id)
...
CREATE TABLE "db_customer" (
	...
	"birth_date"	DATE	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("id")
)
