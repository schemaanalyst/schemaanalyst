-- 17
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(notes, parent_id)
...
CREATE TABLE "db_product" (
	...
	CONSTRAINT "db_product_category_fk" FOREIGN KEY ("category_id", "notes") REFERENCES "db_category" ("id", "parent_id")
)
