-- 9
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ean_code, parent_id)
...
CREATE TABLE "db_product" (
	...
	CONSTRAINT "db_product_category_fk" FOREIGN KEY ("category_id", "ean_code") REFERENCES "db_category" ("id", "parent_id")
)
