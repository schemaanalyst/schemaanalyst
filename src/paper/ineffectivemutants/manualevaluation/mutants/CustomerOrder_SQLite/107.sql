-- 107
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(category_id, id) with Pair(ean_code, id)
...
CREATE TABLE "db_product" (
	"ean_code"	VARCHAR(13)	PRIMARY KEY	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id")	NOT NULL,
	"name"	VARCHAR(30)	NOT NULL,
