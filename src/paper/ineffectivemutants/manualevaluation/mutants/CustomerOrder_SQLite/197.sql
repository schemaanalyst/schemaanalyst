-- 197
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with password
...
CREATE TABLE "db_user" (
	...
	"password"	VARCHAR(16)	PRIMARY KEY	NOT NULL,
