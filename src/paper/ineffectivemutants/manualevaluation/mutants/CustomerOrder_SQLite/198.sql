-- 198
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with role_id
...
CREATE TABLE "db_user" (
	...
	"role_id"	VARCHAR(16)	PRIMARY KEY	CONSTRAINT "db_user_role_fk"  REFERENCES "db_role" ("name")	NOT NULL,
