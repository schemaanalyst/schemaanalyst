-- 119
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(role_id, name) with Pair(active, name)
...
CREATE TABLE "db_user" (
	...
	"active"	SMALLINT	CONSTRAINT "db_user_role_fk"  REFERENCES "db_role" ("name")	NOT NULL,
