-- 121
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(id, id) with Pair(id, email)
...
CREATE TABLE "db_customer" (
	"id"	INT	PRIMARY KEY	CONSTRAINT "db_customer_user_fk"  REFERENCES "db_user" ("email")	NOT NULL,
