-- 18
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(description, name)
...
CREATE TABLE "db_product" (
	...
	CONSTRAINT "db_product_category_fk" FOREIGN KEY ("category_id", "description") REFERENCES "db_category" ("id", "name")
)
