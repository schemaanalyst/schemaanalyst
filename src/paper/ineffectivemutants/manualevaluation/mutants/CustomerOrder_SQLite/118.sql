-- 118
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(role_id, name) with Pair(password, name)
...
CREATE TABLE "db_user" (
	...
	"password"	VARCHAR(16)	CONSTRAINT "db_user_role_fk"  REFERENCES "db_role" ("name")	NOT NULL,
