-- 116
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(role_id, name) with Pair(name, name)
...
CREATE TABLE "db_user" (
	...
	"name"	VARCHAR(30)	CONSTRAINT "db_user_role_fk"  REFERENCES "db_role" ("name")	NOT NULL,
