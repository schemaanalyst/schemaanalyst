-- 9
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(GRADUATE, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("DEPT_ID", "GRADUATE") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
