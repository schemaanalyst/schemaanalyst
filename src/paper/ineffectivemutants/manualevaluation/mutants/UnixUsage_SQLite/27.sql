-- 27
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(RACE, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "RACE") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "HAS_PRINTER")
)
