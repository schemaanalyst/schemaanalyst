-- 136
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(DEPT_ID, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT	 REFERENCES "DEPT_INFO" ("DEPT_ID")	 REFERENCES "OFFICE_INFO" ("OFFICE_ID"),
	"OFFICE_ID"	INT,
	"GRADUATE"	SMALLINT,
