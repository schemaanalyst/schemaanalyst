-- 184
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(COMMAND_SEQ, USER_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"SESSION_ID"	INT,
	"LINE_NO"	INT,
	"COMMAND_SEQ"	INT	 REFERENCES "USER_INFO" ("USER_ID"),
	"COMMAND"	VARCHAR(50)
)
