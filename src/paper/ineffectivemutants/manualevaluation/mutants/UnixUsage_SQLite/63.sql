-- 63
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SCORE, ENROLL_DATE)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "SCORE") REFERENCES "USER_INFO" ("USER_ID", "ENROLL_DATE")
)
