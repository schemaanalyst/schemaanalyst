-- 2
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(COURSE_NAME, DEPT_NAME)
...
CREATE TABLE "COURSE_INFO" (
	...
	FOREIGN KEY ("OFFERED_DEPT", "COURSE_NAME") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
