-- 170
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(COURSE_ID, COURSE_ID) with Pair(COURSE_ID, GRADUATE_LEVEL)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"COURSE_ID"	INT	 REFERENCES "COURSE_INFO" ("GRADUATE_LEVEL")	NOT NULL,
	"SCORE"	INT,
