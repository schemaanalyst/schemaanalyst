-- 229
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged USER_ID with OFFICE_ID
...
CREATE TABLE "USER_INFO" (
	...
	"OFFICE_ID"	INT	PRIMARY KEY	 REFERENCES "OFFICE_INFO" ("OFFICE_ID"),
	"GRADUATE"	SMALLINT,
