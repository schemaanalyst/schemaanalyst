-- 10
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(RACE, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("DEPT_ID", "RACE") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
