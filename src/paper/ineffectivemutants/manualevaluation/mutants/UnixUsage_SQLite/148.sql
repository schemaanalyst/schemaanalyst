-- 148
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(DEPT_ID, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT	 REFERENCES "DEPT_INFO" ("DEPT_ID")	 REFERENCES "RACE_INFO" ("RACE_CODE"),
