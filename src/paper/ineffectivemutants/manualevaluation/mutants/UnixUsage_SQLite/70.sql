-- 70
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SESSION_ID, FIRST_NAME)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50),
	FOREIGN KEY ("USER_ID", "SESSION_ID") REFERENCES "USER_INFO" ("USER_ID", "FIRST_NAME")
)
