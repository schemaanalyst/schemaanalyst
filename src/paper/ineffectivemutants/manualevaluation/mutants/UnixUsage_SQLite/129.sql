-- 129
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(PASSWORD, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"PASSWORD"	VARCHAR(50)	 REFERENCES "DEPT_INFO" ("DEPT_ID")	NOT NULL,
