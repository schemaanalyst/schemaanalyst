-- 221
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged COURSE_ID with GRADUATE_LEVEL
...
CREATE TABLE "COURSE_INFO" (
	...
	"GRADUATE_LEVEL"	SMALLINT	PRIMARY KEY
)
