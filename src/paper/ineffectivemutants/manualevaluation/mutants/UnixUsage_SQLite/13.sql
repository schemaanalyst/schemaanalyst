-- 13
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ENROLL_DATE, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("DEPT_ID", "ENROLL_DATE") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
