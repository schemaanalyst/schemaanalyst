-- 62
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SCORE, YEARS_USING_UNIX)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "SCORE") REFERENCES "USER_INFO" ("USER_ID", "YEARS_USING_UNIX")
)
