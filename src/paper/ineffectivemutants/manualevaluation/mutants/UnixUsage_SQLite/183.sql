-- 183
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(LINE_NO, USER_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"SESSION_ID"	INT,
	"LINE_NO"	INT	 REFERENCES "USER_INFO" ("USER_ID"),
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50)
)
