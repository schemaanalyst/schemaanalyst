-- 125
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(DEPT_ID, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT	 REFERENCES "DEPT_INFO" ("DEPT_NAME"),
