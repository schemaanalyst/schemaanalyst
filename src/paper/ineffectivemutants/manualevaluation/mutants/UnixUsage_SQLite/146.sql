-- 146
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(LAST_NAME, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"LAST_NAME"	VARCHAR(50)	 REFERENCES "RACE_INFO" ("RACE_CODE"),
	"SEX"	VARCHAR(1),
