-- 123
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(LAST_NAME, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"LAST_NAME"	VARCHAR(50)	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT,
