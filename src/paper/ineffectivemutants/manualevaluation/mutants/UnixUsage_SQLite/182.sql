-- 182
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(SESSION_ID, USER_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"SESSION_ID"	INT	 REFERENCES "USER_INFO" ("USER_ID"),
	"LINE_NO"	INT,
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50)
)
