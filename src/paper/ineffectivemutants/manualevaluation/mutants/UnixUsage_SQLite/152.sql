-- 152
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(PASSWORD, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT,
	"RACE"	INT,
	"PASSWORD"	VARCHAR(50)	 REFERENCES "RACE_INFO" ("RACE_CODE")	NOT NULL,
