-- 189
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added GRADUATE_LEVEL
...
CREATE TABLE "COURSE_INFO" (
	...
	PRIMARY KEY ("COURSE_ID", "GRADUATE_LEVEL")
)
