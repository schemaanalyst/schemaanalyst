-- 220
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged COURSE_ID with OFFERED_DEPT
...
CREATE TABLE "COURSE_INFO" (
	...
	"OFFERED_DEPT"	INT	PRIMARY KEY	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
