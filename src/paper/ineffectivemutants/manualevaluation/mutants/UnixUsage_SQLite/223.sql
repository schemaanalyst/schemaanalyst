-- 223
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged OFFICE_ID with HAS_PRINTER
...
CREATE TABLE "OFFICE_INFO" (
	...
	"HAS_PRINTER"	SMALLINT	PRIMARY KEY
)
