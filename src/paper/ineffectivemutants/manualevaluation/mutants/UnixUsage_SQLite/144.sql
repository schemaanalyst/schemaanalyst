-- 144
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(USER_ID, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	"USER_ID"	VARCHAR(50)	PRIMARY KEY	 REFERENCES "RACE_INFO" ("RACE_CODE")	NOT NULL,
