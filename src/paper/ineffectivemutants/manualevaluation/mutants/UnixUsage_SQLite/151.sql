-- 151
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(RACE, RACE)
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT,
	"RACE"	INT	 REFERENCES "RACE_INFO" ("RACE"),
