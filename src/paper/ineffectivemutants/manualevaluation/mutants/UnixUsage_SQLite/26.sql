-- 26
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(RACE, OFFICE_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "RACE") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "OFFICE_NAME")
)
