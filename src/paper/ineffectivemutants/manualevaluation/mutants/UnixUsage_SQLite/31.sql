-- 31
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(YEARS_USING_UNIX, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "YEARS_USING_UNIX") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "HAS_PRINTER")
)
