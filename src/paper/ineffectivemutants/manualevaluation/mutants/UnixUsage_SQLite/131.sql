-- 131
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(ENROLL_DATE, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE	 REFERENCES "DEPT_INFO" ("DEPT_ID")
)
