-- 231
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged USER_ID with RACE
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT,
	"RACE"	INT	PRIMARY KEY	 REFERENCES "RACE_INFO" ("RACE_CODE"),
