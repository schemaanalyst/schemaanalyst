-- 161
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(USER_ID, RACE)
...
CREATE TABLE "TRANSCRIPT" (
	"USER_ID"	VARCHAR(50)	 REFERENCES "USER_INFO" ("RACE")	NOT NULL,
