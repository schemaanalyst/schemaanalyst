-- 147
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(SEX, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1)	 REFERENCES "RACE_INFO" ("RACE_CODE"),
