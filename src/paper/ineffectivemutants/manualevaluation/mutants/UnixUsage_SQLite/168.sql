-- 168
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(COURSE_ID, COURSE_ID) with Pair(COURSE_ID, COURSE_NAME)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"COURSE_ID"	INT	 REFERENCES "COURSE_INFO" ("COURSE_NAME")	NOT NULL,
	"SCORE"	INT,
