-- 44
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(COURSE_ID, FIRST_NAME)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "COURSE_ID") REFERENCES "USER_INFO" ("USER_ID", "FIRST_NAME")
)
