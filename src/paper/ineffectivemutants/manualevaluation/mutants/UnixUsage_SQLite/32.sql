-- 32
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ENROLL_DATE, OFFICE_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "ENROLL_DATE") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "OFFICE_NAME")
)
