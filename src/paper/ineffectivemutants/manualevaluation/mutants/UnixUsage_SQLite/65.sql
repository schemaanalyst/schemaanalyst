-- 65
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(USER_ID, OFFERED_DEPT)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("COURSE_ID", "USER_ID") REFERENCES "COURSE_INFO" ("COURSE_ID", "OFFERED_DEPT")
)
