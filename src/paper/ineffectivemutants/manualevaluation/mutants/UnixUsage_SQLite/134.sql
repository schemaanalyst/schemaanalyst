-- 134
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(LAST_NAME, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"LAST_NAME"	VARCHAR(50)	 REFERENCES "OFFICE_INFO" ("OFFICE_ID"),
	"SEX"	VARCHAR(1),
