-- 132
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(USER_ID, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	"USER_ID"	VARCHAR(50)	PRIMARY KEY	 REFERENCES "OFFICE_INFO" ("OFFICE_ID")	NOT NULL,
