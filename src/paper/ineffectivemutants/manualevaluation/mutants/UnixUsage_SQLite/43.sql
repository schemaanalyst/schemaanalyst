-- 43
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ENROLL_DATE, RACE)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("RACE", "ENROLL_DATE") REFERENCES "RACE_INFO" ("RACE_CODE", "RACE")
)
