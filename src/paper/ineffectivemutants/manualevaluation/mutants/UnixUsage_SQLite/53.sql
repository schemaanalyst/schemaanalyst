-- 53
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(COURSE_ID, ENROLL_DATE)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "COURSE_ID") REFERENCES "USER_INFO" ("USER_ID", "ENROLL_DATE")
)
