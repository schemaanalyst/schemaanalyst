-- 141
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(PASSWORD, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"PASSWORD"	VARCHAR(50)	 REFERENCES "OFFICE_INFO" ("OFFICE_ID")	NOT NULL,
