-- 135
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(SEX, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1)	 REFERENCES "OFFICE_INFO" ("OFFICE_ID"),
