-- 150
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(GRADUATE, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"GRADUATE"	SMALLINT	 REFERENCES "RACE_INFO" ("RACE_CODE"),
	"RACE"	INT,
