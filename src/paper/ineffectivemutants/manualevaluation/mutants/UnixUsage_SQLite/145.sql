-- 145
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(FIRST_NAME, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"FIRST_NAME"	VARCHAR(50)	 REFERENCES "RACE_INFO" ("RACE_CODE"),
