-- 180
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(USER_ID, YEARS_USING_UNIX)
...
CREATE TABLE "USAGE_HISTORY" (
	"USER_ID"	VARCHAR(50)	 REFERENCES "USER_INFO" ("YEARS_USING_UNIX")	NOT NULL,
	"SESSION_ID"	INT,
	"LINE_NO"	INT,
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50)
