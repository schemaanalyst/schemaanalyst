-- 185
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(COMMAND, USER_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"LINE_NO"	INT,
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50)	 REFERENCES "USER_INFO" ("USER_ID")
)
