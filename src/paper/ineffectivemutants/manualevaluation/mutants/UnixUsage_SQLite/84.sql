-- 84
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(LINE_NO, OFFICE_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50),
	FOREIGN KEY ("USER_ID", "LINE_NO") REFERENCES "USER_INFO" ("USER_ID", "OFFICE_ID")
)
