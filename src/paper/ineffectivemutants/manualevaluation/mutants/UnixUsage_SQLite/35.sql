-- 35
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(FIRST_NAME, RACE)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("RACE", "FIRST_NAME") REFERENCES "RACE_INFO" ("RACE_CODE", "RACE")
)
