-- 42
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(YEARS_USING_UNIX, RACE)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("RACE", "YEARS_USING_UNIX") REFERENCES "RACE_INFO" ("RACE_CODE", "RACE")
)
