-- 130
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(YEARS_USING_UNIX, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"YEARS_USING_UNIX"	INT	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
	"ENROLL_DATE"	DATE
)
