-- 12
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(YEARS_USING_UNIX, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("DEPT_ID", "YEARS_USING_UNIX") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
