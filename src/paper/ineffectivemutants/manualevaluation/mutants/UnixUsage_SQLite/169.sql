-- 169
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(COURSE_ID, COURSE_ID) with Pair(COURSE_ID, OFFERED_DEPT)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"COURSE_ID"	INT	 REFERENCES "COURSE_INFO" ("OFFERED_DEPT")	NOT NULL,
	"SCORE"	INT,
