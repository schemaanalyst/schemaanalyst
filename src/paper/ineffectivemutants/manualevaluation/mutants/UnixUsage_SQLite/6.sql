-- 6
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(LAST_NAME, DEPT_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("DEPT_ID", "LAST_NAME") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
