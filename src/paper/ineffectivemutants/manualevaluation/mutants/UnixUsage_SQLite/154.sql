-- 154
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(ENROLL_DATE, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE	 REFERENCES "RACE_INFO" ("RACE_CODE")
)
