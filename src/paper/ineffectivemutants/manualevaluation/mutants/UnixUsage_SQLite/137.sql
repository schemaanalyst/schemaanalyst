-- 137
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(OFFICE_ID, OFFICE_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"OFFICE_ID"	INT	 REFERENCES "OFFICE_INFO" ("OFFICE_NAME"),
	"GRADUATE"	SMALLINT,
