-- 17
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(FIRST_NAME, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "FIRST_NAME") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "HAS_PRINTER")
)
