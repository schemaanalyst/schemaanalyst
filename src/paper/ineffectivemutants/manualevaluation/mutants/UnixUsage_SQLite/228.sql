-- 228
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged USER_ID with DEPT_ID
...
CREATE TABLE "USER_INFO" (
	...
	"SEX"	VARCHAR(1),
	"DEPT_ID"	INT	PRIMARY KEY	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
