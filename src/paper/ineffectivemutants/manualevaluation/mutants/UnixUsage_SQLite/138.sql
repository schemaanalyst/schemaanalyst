-- 138
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(OFFICE_ID, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"OFFICE_ID"	INT	 REFERENCES "OFFICE_INFO" ("HAS_PRINTER"),
	"GRADUATE"	SMALLINT,
