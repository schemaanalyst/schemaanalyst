-- 1
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(COURSE_ID, DEPT_NAME)
...
CREATE TABLE "COURSE_INFO" (
	...
	FOREIGN KEY ("OFFERED_DEPT", "COURSE_ID") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
