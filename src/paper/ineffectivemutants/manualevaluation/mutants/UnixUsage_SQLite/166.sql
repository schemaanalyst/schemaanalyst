-- 166
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(SCORE, USER_ID)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"SCORE"	INT	 REFERENCES "USER_INFO" ("USER_ID"),
