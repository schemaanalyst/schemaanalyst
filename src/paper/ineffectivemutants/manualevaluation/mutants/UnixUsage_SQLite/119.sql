-- 119
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFERED_DEPT, DEPT_ID) with Pair(OFFERED_DEPT, DEPT_NAME)
...
CREATE TABLE "COURSE_INFO" (
	...
	"OFFERED_DEPT"	INT	 REFERENCES "DEPT_INFO" ("DEPT_NAME"),
