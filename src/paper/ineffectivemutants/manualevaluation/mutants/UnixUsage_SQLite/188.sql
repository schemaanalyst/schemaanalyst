-- 188
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added OFFERED_DEPT
...
CREATE TABLE "COURSE_INFO" (
	...
	PRIMARY KEY ("COURSE_ID", "OFFERED_DEPT")
)
