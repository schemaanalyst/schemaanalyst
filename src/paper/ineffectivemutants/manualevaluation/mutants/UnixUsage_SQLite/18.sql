-- 18
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(LAST_NAME, OFFICE_NAME)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "LAST_NAME") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "OFFICE_NAME")
)
