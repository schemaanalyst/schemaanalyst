-- 25
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(GRADUATE, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "GRADUATE") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "HAS_PRINTER")
)
