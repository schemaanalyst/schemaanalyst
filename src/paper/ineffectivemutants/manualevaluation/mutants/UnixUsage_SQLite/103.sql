-- 103
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(COMMAND, DEPT_ID)
...
CREATE TABLE "USAGE_HISTORY" (
	...
	"COMMAND_SEQ"	INT,
	"COMMAND"	VARCHAR(50),
	FOREIGN KEY ("USER_ID", "COMMAND") REFERENCES "USER_INFO" ("USER_ID", "DEPT_ID")
)
