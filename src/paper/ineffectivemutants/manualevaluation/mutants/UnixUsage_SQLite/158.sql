-- 158
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(USER_ID, DEPT_ID)
...
CREATE TABLE "TRANSCRIPT" (
	"USER_ID"	VARCHAR(50)	 REFERENCES "USER_INFO" ("DEPT_ID")	NOT NULL,
