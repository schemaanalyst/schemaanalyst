-- 33
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ENROLL_DATE, HAS_PRINTER)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE,
	FOREIGN KEY ("OFFICE_ID", "ENROLL_DATE") REFERENCES "OFFICE_INFO" ("OFFICE_ID", "HAS_PRINTER")
)
