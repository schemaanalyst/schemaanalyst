-- 58
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SCORE, OFFICE_ID)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "SCORE") REFERENCES "USER_INFO" ("USER_ID", "OFFICE_ID")
)
