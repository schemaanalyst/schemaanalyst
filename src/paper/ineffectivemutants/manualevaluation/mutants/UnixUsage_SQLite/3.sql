-- 3
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(GRADUATE_LEVEL, DEPT_NAME)
...
CREATE TABLE "COURSE_INFO" (
	...
	FOREIGN KEY ("OFFERED_DEPT", "GRADUATE_LEVEL") REFERENCES "DEPT_INFO" ("DEPT_ID", "DEPT_NAME")
)
