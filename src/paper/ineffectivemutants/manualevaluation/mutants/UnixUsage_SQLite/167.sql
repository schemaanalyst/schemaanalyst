-- 167
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(COURSE_ID, COURSE_ID) with Pair(USER_ID, COURSE_ID)
...
CREATE TABLE "TRANSCRIPT" (
	"USER_ID"	VARCHAR(50)	 REFERENCES "USER_INFO" ("USER_ID")	 REFERENCES "COURSE_INFO" ("COURSE_ID")	NOT NULL,
