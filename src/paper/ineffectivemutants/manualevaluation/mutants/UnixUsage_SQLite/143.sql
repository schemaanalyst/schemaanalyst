-- 143
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFICE_ID, OFFICE_ID) with Pair(ENROLL_DATE, OFFICE_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"ENROLL_DATE"	DATE	 REFERENCES "OFFICE_INFO" ("OFFICE_ID")
)
