-- 153
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(RACE, RACE_CODE) with Pair(YEARS_USING_UNIX, RACE_CODE)
...
CREATE TABLE "USER_INFO" (
	...
	"YEARS_USING_UNIX"	INT	 REFERENCES "RACE_INFO" ("RACE_CODE"),
	"ENROLL_DATE"	DATE
)
