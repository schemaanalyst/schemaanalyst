-- 118
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OFFERED_DEPT, DEPT_ID) with Pair(COURSE_NAME, DEPT_ID)
...
CREATE TABLE "COURSE_INFO" (
	...
	"COURSE_NAME"	VARCHAR(50)	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
	"OFFERED_DEPT"	INT,
