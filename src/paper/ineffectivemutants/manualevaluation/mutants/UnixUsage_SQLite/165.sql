-- 165
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(USER_ID, USER_ID) with Pair(COURSE_ID, USER_ID)
...
CREATE TABLE "TRANSCRIPT" (
	...
	"COURSE_ID"	INT	 REFERENCES "COURSE_INFO" ("COURSE_ID")	 REFERENCES "USER_INFO" ("USER_ID")	NOT NULL,
	"SCORE"	INT,
