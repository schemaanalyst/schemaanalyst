-- 122
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(DEPT_ID, DEPT_ID) with Pair(FIRST_NAME, DEPT_ID)
...
CREATE TABLE "USER_INFO" (
	...
	"FIRST_NAME"	VARCHAR(50)	 REFERENCES "DEPT_INFO" ("DEPT_ID"),
