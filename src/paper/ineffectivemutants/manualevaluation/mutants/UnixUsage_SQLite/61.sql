-- 61
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SCORE, PASSWORD)
...
CREATE TABLE "TRANSCRIPT" (
	...
	FOREIGN KEY ("USER_ID", "SCORE") REFERENCES "USER_INFO" ("USER_ID", "PASSWORD")
)
