-- 2
-- CCNullifier
-- ElementNullifier with ChainedSupplier with CheckConstraintSupplier and CheckExpressionSupplier - set ((book_id IS NOT NULL) AND (edition IS NOT NULL)) to null
