-- 85
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged isbn with retail
...
CREATE TABLE "stock" (
	...
	"cost"	NUMERIC(5, 2),
	"retail"	NUMERIC(5, 2)	CONSTRAINT "stock_pkey" PRIMARY KEY,
	"stock"	INT
)
