-- 20
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added stock
...
CREATE TABLE "stock" (
	...
	"retail"	NUMERIC(5, 2),
	"stock"	INT,
	CONSTRAINT "stock_pkey" PRIMARY KEY ("isbn", "stock")
)
