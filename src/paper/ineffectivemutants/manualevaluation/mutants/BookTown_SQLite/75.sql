-- 75
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with title

CREATE TABLE "books" (
	"id"	INT	NOT NULL,
	"title"	VARCHAR(100)	CONSTRAINT "books_id_pkey" PRIMARY KEY	NOT NULL,
	"author_id"	INT,
	"subject_id"	INT
)
