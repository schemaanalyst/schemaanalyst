-- 83
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with abbreviation
...
CREATE TABLE "states" (
	"id"	INT	NOT NULL,
	"name"	VARCHAR(100),
	"abbreviation"	CHAR(2)	CONSTRAINT "state_pkey" PRIMARY KEY
)
