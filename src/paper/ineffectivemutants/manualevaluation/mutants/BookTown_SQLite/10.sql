-- 10
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added subject_id
...
CREATE TABLE "books" (
	...
	"author_id"	INT,
	"subject_id"	INT,
	CONSTRAINT "books_id_pkey" PRIMARY KEY ("id", "subject_id")
)
