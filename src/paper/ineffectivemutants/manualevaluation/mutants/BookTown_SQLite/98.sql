-- 98
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with award
...
CREATE TABLE "distinguished_authors" (
	...
	"last_name"	VARCHAR(100),
	"first_name"	VARCHAR(100),
	"award"	VARCHAR(100)	CONSTRAINT "distinguished_authors_pkey" PRIMARY KEY
)
