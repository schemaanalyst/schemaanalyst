-- 84
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged isbn with cost
...
CREATE TABLE "stock" (
	...
	"cost"	NUMERIC(5, 2)	CONSTRAINT "stock_pkey" PRIMARY KEY,
	"retail"	NUMERIC(5, 2),
	"stock"	INT
)
