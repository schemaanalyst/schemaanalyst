-- 50
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added date_reordered
...
CREATE TABLE "reorder" (
	...
	"date_reordered"	DATE	PRIMARY KEY,
	"quan_reordered"	INT,
	"date_expected"	DATE
)
