-- 19
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added creditcard
...
CREATE TABLE "customers" (
	...
	"creditcard"	VARCHAR(50)	PRIMARY KEY	NOT NULL,
