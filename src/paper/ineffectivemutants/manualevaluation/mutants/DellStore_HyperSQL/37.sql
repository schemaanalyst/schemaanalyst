-- 37
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added netamount
...
CREATE TABLE "orders" (
	...
	"orderdate"	DATE	NOT NULL,
	"customerid"	INT,
	"netamount"	NUMERIC(12, 2)	PRIMARY KEY	NOT NULL,
