-- 52
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added date_expected
...
CREATE TABLE "reorder" (
	...
	"date_reordered"	DATE,
	"quan_reordered"	INT,
	"date_expected"	DATE	PRIMARY KEY
)
