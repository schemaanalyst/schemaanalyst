-- 51
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added quan_reordered
...
CREATE TABLE "reorder" (
	...
	"date_reordered"	DATE,
	"quan_reordered"	INT	PRIMARY KEY,
	"date_expected"	DATE
)
