-- 9
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added address1
...
CREATE TABLE "customers" (
	...
	"address1"	VARCHAR(50)	PRIMARY KEY	NOT NULL,
	"address2"	VARCHAR(50),
