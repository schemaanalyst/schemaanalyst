-- 6
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Start_Page
...
CREATE TABLE "DATA_SRC" (
	...
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
	"Start_Page"	LONGVARCHAR	PRIMARY KEY,
