-- 179
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged NDB_No with Std_Dev
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	LONGVARCHAR,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("Std_Dev", "DataSrc_ID", "FoodNo", "Nutr_No")
)
