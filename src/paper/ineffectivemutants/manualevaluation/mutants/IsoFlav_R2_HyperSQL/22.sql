-- 22
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added NutrDesc
...
CREATE TABLE "NUTR_DEF" (
	...
	"NutrDesc"	LONGVARCHAR	PRIMARY KEY,
	"Unit"	LONGVARCHAR
)
