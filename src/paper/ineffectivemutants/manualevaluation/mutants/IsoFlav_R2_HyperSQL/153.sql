-- 153
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Title

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL,
	"Authors"	LONGVARCHAR,
	"Title"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
