-- 157
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Start_Page
...
CREATE TABLE "DATA_SRC" (
	...
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
	"Start_Page"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
