-- 130
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added DataSrc_ID
...
CREATE TABLE "ISFL_DAT" (
	...
	CONSTRAINT "ISFL_DAT_PrimaryKey" UNIQUE ("NDB_No", "Nutr_No", "DataSrc_ID")
)
