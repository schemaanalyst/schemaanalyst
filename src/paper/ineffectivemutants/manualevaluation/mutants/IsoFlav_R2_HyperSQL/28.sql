-- 28
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Food_Detail_Desc
...
CREATE TABLE "SYBN_DTL" (
	...
	"DataSrc_ID"	DECIMAL,
	"FoodNo"	LONGVARCHAR,
	"Food_Detail_Desc"	LONGVARCHAR	PRIMARY KEY,
	"Nutr_Val"	DECIMAL,
	"Std_Dev"	DECIMAL,
