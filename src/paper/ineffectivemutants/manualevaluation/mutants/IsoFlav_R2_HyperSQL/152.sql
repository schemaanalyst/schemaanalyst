-- 152
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Authors

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL,
	"Authors"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
