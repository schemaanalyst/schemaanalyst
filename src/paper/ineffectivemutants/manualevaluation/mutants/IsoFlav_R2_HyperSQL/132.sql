-- 132
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Unit
...
CREATE TABLE "NUTR_DEF" (
	...
	"Unit"	LONGVARCHAR,
	CONSTRAINT "NUTR_DEF_PrimaryKey" UNIQUE ("Nutr_no", "Unit")
)
