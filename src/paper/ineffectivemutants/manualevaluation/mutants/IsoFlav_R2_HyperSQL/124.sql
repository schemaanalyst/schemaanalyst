-- 124
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Isfl_Val
...
CREATE TABLE "ISFL_DAT" (
	...
	CONSTRAINT "ISFL_DAT_PrimaryKey" UNIQUE ("NDB_No", "Nutr_No", "Isfl_Val")
)
