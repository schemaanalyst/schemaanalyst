-- 180
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged NDB_No with Num_Data_Pts
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	LONGVARCHAR,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("Num_Data_Pts", "DataSrc_ID", "FoodNo", "Nutr_No")
)
