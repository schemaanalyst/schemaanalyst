-- 133
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Food_Detail_Desc
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	LONGVARCHAR,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("NDB_No", "DataSrc_ID", "FoodNo", "Nutr_No", "Food_Detail_Desc")
)
