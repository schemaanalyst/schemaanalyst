-- 120
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Start_Page
...
CREATE TABLE "DATA_SRC" (
	...
	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE ("DataSrc_ID", "Start_Page")
)
