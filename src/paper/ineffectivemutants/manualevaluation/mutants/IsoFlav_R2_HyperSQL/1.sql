-- 1
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Authors

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Authors"	LONGVARCHAR	PRIMARY KEY,
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
