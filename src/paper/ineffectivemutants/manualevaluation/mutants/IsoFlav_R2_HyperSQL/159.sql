-- 159
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged NDB_No with FdGrp_Cd
...
CREATE TABLE "FOOD_DES" (
	"NDB_No"	LONGVARCHAR,
	"FdGrp_Cd"	LONGVARCHAR	CONSTRAINT "FOOD_DES_PrimaryKey" UNIQUE,
