-- 172
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged Nutr_No with Max
...
CREATE TABLE "ISFL_DAT" (
	...
	CONSTRAINT "ISFL_DAT_PrimaryKey" UNIQUE ("NDB_No", "Max")
)
