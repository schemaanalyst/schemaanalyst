-- 154
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Year

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL,
	"Authors"	LONGVARCHAR,
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
