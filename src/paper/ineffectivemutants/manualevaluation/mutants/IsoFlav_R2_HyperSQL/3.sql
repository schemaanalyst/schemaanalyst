-- 3
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Year

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Authors"	LONGVARCHAR,
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL	PRIMARY KEY,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR,
