-- 160
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged NDB_No with Long_Desc
...
CREATE TABLE "FOOD_DES" (
	...
	"Long_Desc"	LONGVARCHAR	CONSTRAINT "FOOD_DES_PrimaryKey" UNIQUE
)
