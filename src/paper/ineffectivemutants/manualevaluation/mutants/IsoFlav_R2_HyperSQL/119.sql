-- 119
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Vol
...
CREATE TABLE "DATA_SRC" (
	...
	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE ("DataSrc_ID", "Vol")
)
