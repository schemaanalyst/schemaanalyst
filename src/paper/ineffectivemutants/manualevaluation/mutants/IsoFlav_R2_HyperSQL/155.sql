-- 155
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Journal
...
CREATE TABLE "DATA_SRC" (
	...
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Vol"	LONGVARCHAR,
