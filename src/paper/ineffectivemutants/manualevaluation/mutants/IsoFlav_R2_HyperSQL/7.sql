-- 7
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added End_Page
...
CREATE TABLE "DATA_SRC" (
	...
	"End_Page"	LONGVARCHAR	PRIMARY KEY
)
