-- 4
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Journal
...
CREATE TABLE "DATA_SRC" (
	...
	"Title"	LONGVARCHAR,
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR	PRIMARY KEY,
	"Vol"	LONGVARCHAR,
