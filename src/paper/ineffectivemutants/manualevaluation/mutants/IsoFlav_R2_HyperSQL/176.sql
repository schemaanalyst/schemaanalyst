-- 176
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged Nutr_no with Unit
...
CREATE TABLE "NUTR_DEF" (
	...
	"Unit"	LONGVARCHAR	CONSTRAINT "NUTR_DEF_PrimaryKey" UNIQUE
)
