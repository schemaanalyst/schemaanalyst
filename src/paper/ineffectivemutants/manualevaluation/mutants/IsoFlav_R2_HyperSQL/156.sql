-- 156
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with Vol
...
CREATE TABLE "DATA_SRC" (
	...
	"Year"	DECIMAL,
	"Journal"	LONGVARCHAR,
	"Vol"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
