-- 121
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added End_Page
...
CREATE TABLE "DATA_SRC" (
	...
	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE ("DataSrc_ID", "End_Page")
)
