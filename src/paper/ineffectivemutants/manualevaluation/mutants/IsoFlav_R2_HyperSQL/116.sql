-- 116
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Title
...
CREATE TABLE "DATA_SRC" (
	...
	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE ("DataSrc_ID", "Title")
)
