-- 175
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged Nutr_no with NutrDesc
...
CREATE TABLE "NUTR_DEF" (
	"Nutr_no"	LONGVARCHAR,
	"NutrDesc"	LONGVARCHAR	CONSTRAINT "NUTR_DEF_PrimaryKey" UNIQUE,
	"Unit"	LONGVARCHAR
)
