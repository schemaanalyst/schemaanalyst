-- 158
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged DataSrc_ID with End_Page
...
CREATE TABLE "DATA_SRC" (
	...
	"End_Page"	LONGVARCHAR	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE
)
