-- 25
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added numeric_cash
...
CREATE TABLE "money_example" (
	...
	"numeric_cash"	NUMERIC(6, 2)	PRIMARY KEY
)
