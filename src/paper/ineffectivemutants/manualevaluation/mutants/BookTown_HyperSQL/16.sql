-- 16
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added abbreviation
...
CREATE TABLE "states" (
	...
	"name"	VARCHAR(100),
	"abbreviation"	CHAR(2),
	CONSTRAINT "state_pkey" PRIMARY KEY ("id", "abbreviation")
)
