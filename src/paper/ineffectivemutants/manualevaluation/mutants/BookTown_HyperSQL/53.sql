-- 53
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added subject
...
CREATE TABLE "subjects" (
	...
	CONSTRAINT "subjects_pkey" PRIMARY KEY ("id", "subject")
)
