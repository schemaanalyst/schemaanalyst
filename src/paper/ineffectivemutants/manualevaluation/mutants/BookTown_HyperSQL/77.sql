-- 77
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with subject_id

CREATE TABLE "books" (
	"id"	INT	NOT NULL,
	"title"	VARCHAR(100)	NOT NULL,
	"author_id"	INT,
	"subject_id"	INT	CONSTRAINT "books_id_pkey" PRIMARY KEY
)
