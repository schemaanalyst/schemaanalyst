-- 99
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with subject
...
CREATE TABLE "subjects" (
	"id"	INT	NOT NULL,
	"subject"	VARCHAR(100)	CONSTRAINT "subjects_pkey" PRIMARY KEY,
