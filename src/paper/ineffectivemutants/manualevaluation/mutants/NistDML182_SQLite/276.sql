-- 276
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed CODE4
...
CREATE TABLE "ID_CODES" (
	...
	"CODE14"	INT,
	"CODE15"	INT,
	PRIMARY KEY ("CODE1", "CODE2", "CODE3", "CODE5", "CODE6", "CODE7", "CODE8", "CODE9", "CODE10", "CODE11", "CODE12", "CODE13", "CODE14", "CODE15")
)
