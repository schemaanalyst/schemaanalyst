-- 696
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with DirectionsToHome
...
CREATE TABLE "HistoryPatients" (
	...
	"CreditCardNumber"	VARCHAR(19),
	"MessageFilter"	VARCHAR(60),
	"DirectionsToHome"	VARCHAR(100)	PRIMARY KEY,
	"Religion"	VARCHAR(64),
	"Language"	VARCHAR(32),
	"SpiritualPractices"	VARCHAR(100),
	"AlternateName"	VARCHAR(32),
