-- 430
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added CholesterolHDL
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"BloodPressureN"	INT,
	"BloodPressureD"	INT,
	"CholesterolHDL"	INT	PRIMARY KEY,
	"CholesterolLDL"	INT,
	"CholesterolTri"	INT,
	"HCPID"	INT,
