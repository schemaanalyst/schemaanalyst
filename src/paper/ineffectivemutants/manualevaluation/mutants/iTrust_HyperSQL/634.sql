-- 634
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with iCPhone2
...
CREATE TABLE "Patients" (
	...
	"iCZip2"	VARCHAR(4),
	"iCPhone1"	VARCHAR(3),
	"iCPhone2"	VARCHAR(3)	PRIMARY KEY,
	"iCPhone3"	VARCHAR(4),
	"iCID"	VARCHAR(20),
	"DateOfBirth"	DATE,
	"DateOfDeath"	DATE,
