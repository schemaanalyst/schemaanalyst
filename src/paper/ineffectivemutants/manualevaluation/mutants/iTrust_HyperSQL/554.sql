-- 554
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed FirstDrug
...
CREATE TABLE "DrugInteractions" (
	...
	"SecondDrug"	VARCHAR(9)	PRIMARY KEY	NOT NULL,
	"Description"	VARCHAR(100)	NOT NULL
)
