-- 493
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added sent_date
...
CREATE TABLE "message" (
	...
	"to_id"	INT	NOT NULL,
	"sent_date"	TIMESTAMP	PRIMARY KEY	NOT NULL,
	"message"	VARCHAR(50),
	"subject"	VARCHAR(50),
	"been_read"	INT
)
