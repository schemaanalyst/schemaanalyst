-- 524
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added DiastolicBloodPressure
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PatientMID", "HCPMID", "DiastolicBloodPressure")
)
