-- 733
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with ICDCode
...
CREATE TABLE "OVDiagnosis" (
	"ID"	INT,
	"VisitID"	INT	NOT NULL,
	"ICDCode"	DECIMAL(5, 2)	PRIMARY KEY	NOT NULL
)
