-- 761
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged LaboratoryProcedureID with UpperBound
...
CREATE TABLE "LabProcedure" (
	...
	"UpperBound"	VARCHAR(20)	PRIMARY KEY,
