-- 792
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with ReporterRole
...
CREATE TABLE "RemoteMonitoringData" (
	...
	"timeLogged"	TIMESTAMP	NOT NULL,
	"ReporterRole"	VARCHAR(50)	PRIMARY KEY,
	"ReporterID"	INT
)
