-- 607
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with specialty
...
CREATE TABLE "Personnel" (
	...
	"phone2"	VARCHAR(3),
	"phone3"	VARCHAR(4),
	"specialty"	VARCHAR(40)	PRIMARY KEY,
	"email"	VARCHAR(55),
