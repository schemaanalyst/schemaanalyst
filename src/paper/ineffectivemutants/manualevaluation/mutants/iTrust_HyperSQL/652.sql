-- 652
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with SpiritualPractices
...
CREATE TABLE "Patients" (
	...
	"Religion"	VARCHAR(64),
	"Language"	VARCHAR(32),
	"SpiritualPractices"	VARCHAR(100)	PRIMARY KEY,
