-- 770
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged appt_id with sched_date
...
CREATE TABLE "Appointment" (
	...
	"sched_date"	TIMESTAMP	PRIMARY KEY	NOT NULL,
