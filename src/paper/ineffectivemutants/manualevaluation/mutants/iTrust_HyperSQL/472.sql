-- 472
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added ScaleType
...
CREATE TABLE "LOINC" (
	...
	"System"	VARCHAR(100),
	"ScaleType"	VARCHAR(100)	PRIMARY KEY,
