-- 716
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged transactionID with timeLogged
...
CREATE TABLE "TransactionLog" (
	...
	"timeLogged"	TIMESTAMP	PRIMARY KEY	NOT NULL,
