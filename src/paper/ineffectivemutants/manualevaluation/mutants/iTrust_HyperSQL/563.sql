-- 563
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed PatientID
...
CREATE TABLE "DeclaredHCP" (
	"PatientID"	INT	NOT NULL,
	"HCPID"	INT	PRIMARY KEY	NOT NULL
)
