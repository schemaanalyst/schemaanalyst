-- 649
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with DirectionsToHome
...
CREATE TABLE "Patients" (
	...
	"MessageFilter"	VARCHAR(60),
	"DirectionsToHome"	VARCHAR(512)	PRIMARY KEY,
	"Religion"	VARCHAR(64),
	"Language"	VARCHAR(32),
