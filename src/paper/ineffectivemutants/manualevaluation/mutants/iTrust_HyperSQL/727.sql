-- 727
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with CPTCode
...
CREATE TABLE "OVProcedure" (
	...
	"CPTCode"	VARCHAR(5)	PRIMARY KEY	NOT NULL,
