-- 594
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with lastName
...
CREATE TABLE "Personnel" (
	...
	"lastName"	VARCHAR(20)	PRIMARY KEY	NOT NULL,
