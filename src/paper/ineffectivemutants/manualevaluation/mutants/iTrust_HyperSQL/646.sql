-- 646
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with CreditCardType
...
CREATE TABLE "Patients" (
	...
	"CreditCardType"	VARCHAR(20)	PRIMARY KEY,
