-- 790
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with pedometerReading
...
CREATE TABLE "RemoteMonitoringData" (
	...
	"height"	INT,
	"weight"	INT,
	"pedometerReading"	INT	PRIMARY KEY,
	"timeLogged"	TIMESTAMP	NOT NULL,
