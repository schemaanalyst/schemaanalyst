-- 401
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added failureCount
...
CREATE TABLE "ResetPasswordFailures" (
	...
	"failureCount"	INT	NOT NULL,
	"lastFailure"	TIMESTAMP	NOT NULL,
	PRIMARY KEY ("ipaddress", "failureCount")
)
