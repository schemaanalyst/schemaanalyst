-- 414
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added addedInfo
...
CREATE TABLE "TransactionLog" (
	...
	PRIMARY KEY ("transactionID", "addedInfo")
)
