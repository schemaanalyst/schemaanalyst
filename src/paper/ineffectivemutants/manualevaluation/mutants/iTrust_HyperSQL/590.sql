-- 590
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged HospitalID with HospitalName
...
CREATE TABLE "Hospitals" (
	...
	"HospitalName"	VARCHAR(30)	PRIMARY KEY	NOT NULL
)
