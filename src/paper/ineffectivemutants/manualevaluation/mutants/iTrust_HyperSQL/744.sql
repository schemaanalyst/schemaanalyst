-- 744
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with ApprovedDate
...
CREATE TABLE "ReportRequests" (
	...
	"ApprovedDate"	TIMESTAMP	PRIMARY KEY,
