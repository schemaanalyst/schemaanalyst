-- 739
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with AddedDate
...
CREATE TABLE "FakeEmail" (
	...
	"Subject"	VARCHAR(500),
	"Body"	VARCHAR(2000),
	"AddedDate"	TIMESTAMP	PRIMARY KEY	NOT NULL
)
