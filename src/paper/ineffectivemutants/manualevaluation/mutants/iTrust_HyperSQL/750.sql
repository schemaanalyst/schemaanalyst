-- 750
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged VisitID with ExamRoomMinutes
...
CREATE TABLE "OVSurvey" (
	...
	"ExamRoomMinutes"	INT	PRIMARY KEY,
