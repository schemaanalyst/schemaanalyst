-- 805
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged HCPMID with PedometerReading
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PatientMID", "PedometerReading")
)
