-- 745
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with ViewedDate
...
CREATE TABLE "ReportRequests" (
	...
	"ViewedDate"	TIMESTAMP	PRIMARY KEY,
	"Status"	VARCHAR(30),
	"Comment"	VARCHAR(50)
)
