-- 655
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with changeMID
...
CREATE TABLE "HistoryPatients" (
	...
	"changeMID"	INT	PRIMARY KEY	NOT NULL,
	"MID"	INT	NOT NULL,
	"lastName"	VARCHAR(20),
	"firstName"	VARCHAR(20),
	"email"	VARCHAR(55),
