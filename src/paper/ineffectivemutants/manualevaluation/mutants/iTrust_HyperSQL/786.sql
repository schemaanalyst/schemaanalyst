-- 786
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with diastolicBloodPressure
...
CREATE TABLE "RemoteMonitoringData" (
	...
	"diastolicBloodPressure"	INT	PRIMARY KEY,
	"glucoseLevel"	INT,
	"height"	INT,
	"weight"	INT,
