-- 801
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged HCPMID with DiastolicBloodPressure
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PatientMID", "DiastolicBloodPressure")
)
