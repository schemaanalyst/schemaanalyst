-- 752
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged VisitID with TreatmentSatisfaction
...
CREATE TABLE "OVSurvey" (
	...
	"TreatmentSatisfaction"	INT	PRIMARY KEY
)
