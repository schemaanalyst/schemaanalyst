-- 596
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with address1
...
CREATE TABLE "Personnel" (
	...
	"address1"	VARCHAR(20)	PRIMARY KEY	NOT NULL,
