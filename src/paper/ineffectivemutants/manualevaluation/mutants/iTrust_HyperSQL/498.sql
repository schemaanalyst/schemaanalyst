-- 498
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added patient_id
...
CREATE TABLE "Appointment" (
	...
	"comment"	VARCHAR(50),
	PRIMARY KEY ("appt_id", "patient_id")
)
