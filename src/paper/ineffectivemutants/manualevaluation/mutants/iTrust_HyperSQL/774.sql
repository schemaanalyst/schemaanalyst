-- 774
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged apptType_id with duration
...
CREATE TABLE "AppointmentType" (
	"apptType_id"	INT,
	"appt_type"	VARCHAR(30)	NOT NULL,
	"duration"	INT	PRIMARY KEY	NOT NULL
)
