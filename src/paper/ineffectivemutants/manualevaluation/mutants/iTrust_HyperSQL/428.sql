-- 428
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added BloodPressureN
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"BloodPressureN"	INT	PRIMARY KEY,
	"BloodPressureD"	INT,
	"CholesterolHDL"	INT,
	"CholesterolLDL"	INT,
	"CholesterolTri"	INT,
