-- 432
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added CholesterolTri
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"CholesterolHDL"	INT,
	"CholesterolLDL"	INT,
	"CholesterolTri"	INT	PRIMARY KEY,
	"HCPID"	INT,
