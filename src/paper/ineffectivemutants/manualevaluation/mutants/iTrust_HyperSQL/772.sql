-- 772
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged appt_id with comment
...
CREATE TABLE "Appointment" (
	...
	"comment"	VARCHAR(50)	PRIMARY KEY
)
