-- 503
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added duration
...
CREATE TABLE "AppointmentType" (
	...
	PRIMARY KEY ("apptType_id", "duration")
)
