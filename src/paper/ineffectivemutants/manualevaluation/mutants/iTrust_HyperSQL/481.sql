-- 481
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added NumericalResultsUnit
...
CREATE TABLE "LabProcedure" (
	...
	PRIMARY KEY ("LaboratoryProcedureID", "NumericalResultsUnit")
)
