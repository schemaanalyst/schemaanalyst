-- 706
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged Code with Chronic
...
CREATE TABLE "icdcodes" (
	...
	"Chronic"	VARCHAR(3)	PRIMARY KEY	NOT NULL,
