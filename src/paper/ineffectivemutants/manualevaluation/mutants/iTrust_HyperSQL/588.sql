-- 588
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with sQuestion

CREATE TABLE "Users" (
	"MID"	INT,
	"Password"	VARCHAR(20),
	"Role"	VARCHAR(20)	NOT NULL,
	"sQuestion"	VARCHAR(100)	PRIMARY KEY,
	"sAnswer"	VARCHAR(30),
