-- 427
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added SmokingStatus
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"Weight"	INT,
	"Smoker"	INT	NOT NULL,
	"SmokingStatus"	INT	PRIMARY KEY	NOT NULL,
	"BloodPressureN"	INT,
	"BloodPressureD"	INT,
	"CholesterolHDL"	INT,
	"CholesterolLDL"	INT,
