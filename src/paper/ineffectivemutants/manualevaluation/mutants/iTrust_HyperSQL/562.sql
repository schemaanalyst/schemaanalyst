-- 562
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed HCPID
...
CREATE TABLE "HCPAssignedHos" (
	"hosID"	VARCHAR(10)	PRIMARY KEY	NOT NULL,
	"HCPID"	INT	NOT NULL
)
