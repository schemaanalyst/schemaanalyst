-- 778
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with ReferralDetails
...
CREATE TABLE "referrals" (
	...
	"ReferralDetails"	VARCHAR(50)	PRIMARY KEY,
	"OVID"	INT	NOT NULL,
