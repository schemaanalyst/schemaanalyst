-- 639
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with CauseOfDeath
...
CREATE TABLE "Patients" (
	...
	"DateOfBirth"	DATE,
	"DateOfDeath"	DATE,
	"CauseOfDeath"	VARCHAR(10)	PRIMARY KEY,
	"MotherMID"	INT,
	"FatherMID"	INT,
	"BloodType"	VARCHAR(3),
