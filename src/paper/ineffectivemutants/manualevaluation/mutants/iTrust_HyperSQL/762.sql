-- 762
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged LaboratoryProcedureID with LowerBound
...
CREATE TABLE "LabProcedure" (
	...
	"LowerBound"	VARCHAR(20)	PRIMARY KEY,
	"OfficeVisitID"	INT,
	"LabTechID"	INT,
	"PriorityCode"	INT,
