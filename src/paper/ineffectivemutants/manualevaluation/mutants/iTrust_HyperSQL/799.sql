-- 799
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged PatientMID with PedometerReading
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PedometerReading", "HCPMID")
)
