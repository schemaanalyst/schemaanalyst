-- 766
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged LaboratoryProcedureID with ViewedByPatient
...
CREATE TABLE "LabProcedure" (
	...
	"LabTechID"	INT,
	"PriorityCode"	INT,
	"ViewedByPatient"	BOOLEAN	PRIMARY KEY	NOT NULL,
