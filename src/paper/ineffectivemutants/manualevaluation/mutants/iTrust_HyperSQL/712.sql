-- 712
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SecondDrug with Description
...
CREATE TABLE "DrugInteractions" (
	...
	"Description"	VARCHAR(100)	NOT NULL,
	PRIMARY KEY ("FirstDrug", "Description")
)
