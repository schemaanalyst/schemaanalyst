-- 703
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ipaddress with failureCount
...
CREATE TABLE "ResetPasswordFailures" (
	...
	"failureCount"	INT	PRIMARY KEY	NOT NULL,
	"lastFailure"	TIMESTAMP	NOT NULL
)
