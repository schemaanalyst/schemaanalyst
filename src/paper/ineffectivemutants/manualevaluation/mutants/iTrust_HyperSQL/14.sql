...
-- ListElementRemover with ChainedSupplier with CheckConstraintSupplier and ChainedSupplier with CheckExpressionSupplier and ChainedSupplier with InExpressionRHSListExpressionSupplier and InExpressionRHSListExpressionSubexpressionsSupplier - Removed 'tester'
...
CREATE TABLE "Users" (
	...
	"sAnswer"	VARCHAR(30),
	CHECK ("Role" IN ('patient', 'admin', 'hcp', 'uap', 'er', 'pha', 'lt'))
)
