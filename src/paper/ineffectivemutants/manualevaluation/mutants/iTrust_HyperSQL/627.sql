-- 627
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with iCAddress1
...
CREATE TABLE "Patients" (
	...
	"ePhone3"	VARCHAR(4),
	"iCName"	VARCHAR(20),
	"iCAddress1"	VARCHAR(20)	PRIMARY KEY,
