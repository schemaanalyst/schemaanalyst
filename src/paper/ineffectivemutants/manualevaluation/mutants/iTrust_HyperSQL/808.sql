-- 808
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with PresImmu
...
CREATE TABLE "AdverseEvents" (
	...
	"Status"	VARCHAR(10),
	"PatientMID"	INT,
	"PresImmu"	VARCHAR(50)	PRIMARY KEY,
	"Code"	VARCHAR(20),
