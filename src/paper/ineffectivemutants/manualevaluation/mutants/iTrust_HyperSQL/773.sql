-- 773
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged apptType_id with appt_type
...
CREATE TABLE "AppointmentType" (
	"apptType_id"	INT,
	"appt_type"	VARCHAR(30)	PRIMARY KEY	NOT NULL,
