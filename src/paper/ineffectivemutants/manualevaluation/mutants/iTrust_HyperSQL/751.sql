-- 751
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged VisitID with VisitSatisfaction
...
CREATE TABLE "OVSurvey" (
	...
	"ExamRoomMinutes"	INT,
	"VisitSatisfaction"	INT	PRIMARY KEY,
