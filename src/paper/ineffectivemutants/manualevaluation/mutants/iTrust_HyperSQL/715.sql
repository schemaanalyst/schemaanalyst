-- 715
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged transactionID with transactionCode
...
CREATE TABLE "TransactionLog" (
	...
	"transactionCode"	INT	PRIMARY KEY	NOT NULL,
