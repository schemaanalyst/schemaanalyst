-- 523
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added SystolicBloodPressure
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PatientMID", "HCPMID", "SystolicBloodPressure")
)
