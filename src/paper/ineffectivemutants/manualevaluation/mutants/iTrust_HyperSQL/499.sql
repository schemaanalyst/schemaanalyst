-- 499
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added sched_date
...
CREATE TABLE "Appointment" (
	...
	"comment"	VARCHAR(50),
	PRIMARY KEY ("appt_id", "sched_date")
)
