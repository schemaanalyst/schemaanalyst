-- 635
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with iCPhone3
...
CREATE TABLE "Patients" (
	...
	"iCPhone1"	VARCHAR(3),
	"iCPhone2"	VARCHAR(3),
	"iCPhone3"	VARCHAR(4)	PRIMARY KEY,
	"iCID"	VARCHAR(20),
	"DateOfBirth"	DATE,
	"DateOfDeath"	DATE,
