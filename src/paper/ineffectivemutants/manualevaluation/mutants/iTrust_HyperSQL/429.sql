-- 429
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added BloodPressureD
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"BloodPressureN"	INT,
	"BloodPressureD"	INT	PRIMARY KEY,
	"CholesterolHDL"	INT,
	"CholesterolLDL"	INT,
	"CholesterolTri"	INT,
	"HCPID"	INT,
