-- 754
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged LaboratoryProcedureID with LaboratoryProcedureCode
...
CREATE TABLE "LabProcedure" (
	"LaboratoryProcedureID"	INT,
	"PatientMID"	INT,
	"LaboratoryProcedureCode"	VARCHAR(7)	PRIMARY KEY,
	"Rights"	VARCHAR(10),
	"Status"	VARCHAR(20),
