-- 464
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added ExamRoomMinutes
...
CREATE TABLE "OVSurvey" (
	...
	PRIMARY KEY ("VisitID", "ExamRoomMinutes")
)
