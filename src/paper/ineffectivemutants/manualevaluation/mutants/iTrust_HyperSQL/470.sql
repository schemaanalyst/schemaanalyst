-- 470
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added TimeAspect
...
CREATE TABLE "LOINC" (
	...
	"TimeAspect"	VARCHAR(100)	PRIMARY KEY,
	"System"	VARCHAR(100),
