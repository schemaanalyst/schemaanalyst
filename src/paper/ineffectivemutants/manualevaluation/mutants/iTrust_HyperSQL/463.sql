-- 463
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added WaitingRoomMinutes
...
CREATE TABLE "OVSurvey" (
	...
	PRIMARY KEY ("VisitID", "WaitingRoomMinutes")
)
