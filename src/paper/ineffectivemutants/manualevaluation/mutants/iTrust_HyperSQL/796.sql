-- 796
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged PatientMID with GlucoseLevel
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("GlucoseLevel", "HCPMID")
)
