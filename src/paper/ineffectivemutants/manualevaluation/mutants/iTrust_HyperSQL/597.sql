-- 597
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with address2
...
CREATE TABLE "Personnel" (
	...
	"address2"	VARCHAR(20)	PRIMARY KEY	NOT NULL,
