-- 445
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added OverrideComment
...
CREATE TABLE "OVReactionOverride" (
	...
	PRIMARY KEY ("ID", "OverrideComment")
)
