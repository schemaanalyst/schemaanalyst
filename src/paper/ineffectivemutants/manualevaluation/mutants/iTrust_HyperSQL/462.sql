-- 462
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added SurveyDate
...
CREATE TABLE "OVSurvey" (
	...
	PRIMARY KEY ("VisitID", "SurveyDate")
)
