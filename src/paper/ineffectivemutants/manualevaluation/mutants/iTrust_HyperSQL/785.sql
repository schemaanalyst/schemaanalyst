-- 785
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with systolicBloodPressure
...
CREATE TABLE "RemoteMonitoringData" (
	"id"	INT,
	"PatientID"	INT	NOT NULL,
	"systolicBloodPressure"	INT	PRIMARY KEY,
