-- 730
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with OverrideCode
...
CREATE TABLE "OVReactionOverride" (
	...
	"OverrideCode"	VARCHAR(5)	PRIMARY KEY,
