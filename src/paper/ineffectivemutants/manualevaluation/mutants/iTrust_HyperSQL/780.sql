-- 780
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with viewed_by_patient
...
CREATE TABLE "referrals" (
	...
	"OVID"	INT	NOT NULL,
	"viewed_by_patient"	BOOLEAN	PRIMARY KEY	NOT NULL,
