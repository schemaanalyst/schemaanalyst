-- 400
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added lastFailure
...
CREATE TABLE "LoginFailures" (
	...
	PRIMARY KEY ("ipaddress", "lastFailure")
)
