-- 758
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged LaboratoryProcedureID with Results
...
CREATE TABLE "LabProcedure" (
	...
	"Results"	VARCHAR(50)	PRIMARY KEY,
