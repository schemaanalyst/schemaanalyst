-- 633
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with iCPhone1
...
CREATE TABLE "Patients" (
	...
	"iCZip1"	VARCHAR(5),
	"iCZip2"	VARCHAR(4),
	"iCPhone1"	VARCHAR(3)	PRIMARY KEY,
	"iCPhone2"	VARCHAR(3),
	"iCPhone3"	VARCHAR(4),
	"iCID"	VARCHAR(20),
	"DateOfBirth"	DATE,
