-- 781
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with viewed_by_HCP
...
CREATE TABLE "referrals" (
	...
	"viewed_by_HCP"	BOOLEAN	PRIMARY KEY	NOT NULL,
