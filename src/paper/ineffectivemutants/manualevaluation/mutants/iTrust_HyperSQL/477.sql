-- 477
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Status
...
CREATE TABLE "LabProcedure" (
	...
	PRIMARY KEY ("LaboratoryProcedureID", "Status")
)
