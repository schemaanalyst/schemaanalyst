-- 526
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Height
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("PatientMID", "HCPMID", "Height")
)
