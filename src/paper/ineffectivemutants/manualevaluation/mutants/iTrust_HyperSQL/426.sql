-- 426
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Smoker
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"Height"	INT,
	"Weight"	INT,
	"Smoker"	INT	PRIMARY KEY	NOT NULL,
