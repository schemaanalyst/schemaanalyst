-- 560
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed representeeMID
...
CREATE TABLE "Representatives" (
	"representerMID"	INT	PRIMARY KEY,
	"representeeMID"	INT
)
