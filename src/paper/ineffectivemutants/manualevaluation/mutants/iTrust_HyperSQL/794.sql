-- 794
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged PatientMID with SystolicBloodPressure
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("SystolicBloodPressure", "HCPMID")
)
