-- 469
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added KindOfProperty
...
CREATE TABLE "LOINC" (
	...
	"KindOfProperty"	VARCHAR(100)	PRIMARY KEY,
