-- 431
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added CholesterolLDL
...
CREATE TABLE "PersonalHealthInformation" (
	...
	"BloodPressureD"	INT,
	"CholesterolHDL"	INT,
	"CholesterolLDL"	INT	PRIMARY KEY,
	"CholesterolTri"	INT,
	"HCPID"	INT,
