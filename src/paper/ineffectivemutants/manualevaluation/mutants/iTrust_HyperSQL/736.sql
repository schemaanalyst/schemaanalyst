-- 736
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with FromAddr
...
CREATE TABLE "FakeEmail" (
	"ID"	INT,
	"ToAddr"	VARCHAR(100),
	"FromAddr"	VARCHAR(100)	PRIMARY KEY,
	"Subject"	VARCHAR(500),
	"Body"	VARCHAR(2000),
