-- 492
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added to_id
...
CREATE TABLE "message" (
	...
	"to_id"	INT	PRIMARY KEY	NOT NULL,
