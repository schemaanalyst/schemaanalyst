-- 466
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added TreatmentSatisfaction
...
CREATE TABLE "OVSurvey" (
	...
	PRIMARY KEY ("VisitID", "TreatmentSatisfaction")
)
