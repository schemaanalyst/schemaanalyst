-- 749
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged VisitID with WaitingRoomMinutes
...
CREATE TABLE "OVSurvey" (
	...
	"WaitingRoomMinutes"	INT	PRIMARY KEY,
	"ExamRoomMinutes"	INT,
