-- 704
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ipaddress with lastFailure
...
CREATE TABLE "ResetPasswordFailures" (
	...
	"failureCount"	INT	NOT NULL,
	"lastFailure"	TIMESTAMP	PRIMARY KEY	NOT NULL
)
