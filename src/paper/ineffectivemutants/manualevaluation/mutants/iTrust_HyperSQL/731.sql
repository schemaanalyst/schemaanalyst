-- 731
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with OverrideComment
...
CREATE TABLE "OVReactionOverride" (
	...
	"OverrideComment"	VARCHAR(255)	PRIMARY KEY
)
