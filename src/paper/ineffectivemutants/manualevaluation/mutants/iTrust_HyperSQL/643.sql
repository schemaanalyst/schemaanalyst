-- 643
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with Ethnicity
...
CREATE TABLE "Patients" (
	...
	"FatherMID"	INT,
	"BloodType"	VARCHAR(3),
	"Ethnicity"	VARCHAR(20)	PRIMARY KEY,
	"Gender"	VARCHAR(13),
