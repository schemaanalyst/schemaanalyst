-- 725
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with FirstFound
...
CREATE TABLE "Allergies" (
	...
	"PatientID"	INT	NOT NULL,
	"Description"	VARCHAR(50)	NOT NULL,
	"FirstFound"	TIMESTAMP	PRIMARY KEY	NOT NULL
)
