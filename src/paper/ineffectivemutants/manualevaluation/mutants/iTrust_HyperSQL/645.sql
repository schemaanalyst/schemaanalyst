-- 645
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with TopicalNotes
...
CREATE TABLE "Patients" (
	...
	"Gender"	VARCHAR(13),
	"TopicalNotes"	VARCHAR(200)	PRIMARY KEY,
