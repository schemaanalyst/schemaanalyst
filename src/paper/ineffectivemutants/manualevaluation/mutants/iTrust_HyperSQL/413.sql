-- 413
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added timeLogged
...
CREATE TABLE "TransactionLog" (
	...
	PRIMARY KEY ("transactionID", "timeLogged")
)
