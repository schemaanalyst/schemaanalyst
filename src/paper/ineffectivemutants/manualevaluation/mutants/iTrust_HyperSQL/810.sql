-- 810
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with Comment
...
CREATE TABLE "AdverseEvents" (
	...
	"PresImmu"	VARCHAR(50),
	"Code"	VARCHAR(20),
	"Comment"	VARCHAR(2000)	PRIMARY KEY,
	"Prescriber"	INT,
