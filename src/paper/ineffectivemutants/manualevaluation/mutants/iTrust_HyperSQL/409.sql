-- 409
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Description
...
CREATE TABLE "DrugInteractions" (
	...
	"Description"	VARCHAR(100)	NOT NULL,
	PRIMARY KEY ("FirstDrug", "SecondDrug", "Description")
)
