-- 735
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with ToAddr
...
CREATE TABLE "FakeEmail" (
	"ID"	INT,
	"ToAddr"	VARCHAR(100)	PRIMARY KEY,
