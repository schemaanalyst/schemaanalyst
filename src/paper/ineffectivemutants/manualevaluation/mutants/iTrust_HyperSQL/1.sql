-- 1
-- CCNullifier
-- ElementNullifier with ChainedSupplier with CheckConstraintSupplier and CheckExpressionSupplier - set Role IN ('patient', 'admin', 'hcp', 'uap', 'er', 'tester', 'pha', 'lt') to null
