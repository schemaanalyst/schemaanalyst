-- 628
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with iCAddress2
...
CREATE TABLE "Patients" (
	...
	"iCAddress2"	VARCHAR(20)	PRIMARY KEY,
	"iCCity"	VARCHAR(15),
	"ICState"	VARCHAR(2),
	"iCZip1"	VARCHAR(5),
	"iCZip2"	VARCHAR(4),
