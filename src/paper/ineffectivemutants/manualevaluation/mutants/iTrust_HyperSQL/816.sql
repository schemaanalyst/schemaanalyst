-- 816
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with Modified
...
CREATE TABLE "PatientSpecificInstructions" (
	"id"	INT,
	"VisitID"	INT,
	"Modified"	TIMESTAMP	PRIMARY KEY	NOT NULL,
	"Name"	VARCHAR(100),
	"URL"	VARCHAR(250),
	"Comment"	VARCHAR(500)
)
