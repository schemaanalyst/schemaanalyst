-- 478
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Commentary
...
CREATE TABLE "LabProcedure" (
	...
	PRIMARY KEY ("LaboratoryProcedureID", "Commentary")
)
