-- 728
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with HCPID
...
CREATE TABLE "OVProcedure" (
	...
	"HCPID"	VARCHAR(10)	PRIMARY KEY	NOT NULL
)
