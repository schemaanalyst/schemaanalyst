-- 795
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged PatientMID with DiastolicBloodPressure
...
CREATE TABLE "RemoteMonitoringLists" (
	...
	PRIMARY KEY ("DiastolicBloodPressure", "HCPMID")
)
