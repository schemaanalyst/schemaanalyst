-- 593
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged MID with enabled
...
CREATE TABLE "Personnel" (
	...
	"AMID"	INT,
	"role"	VARCHAR(20)	NOT NULL,
	"enabled"	INT	PRIMARY KEY	NOT NULL,
