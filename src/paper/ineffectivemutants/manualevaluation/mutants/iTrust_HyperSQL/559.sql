-- 559
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed representerMID
...
CREATE TABLE "Representatives" (
	"representerMID"	INT,
	"representeeMID"	INT	PRIMARY KEY
)
