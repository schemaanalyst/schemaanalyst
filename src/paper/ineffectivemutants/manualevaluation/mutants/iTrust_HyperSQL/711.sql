-- 711
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged FirstDrug with Description
...
CREATE TABLE "DrugInteractions" (
	...
	"Description"	VARCHAR(100)	NOT NULL,
	PRIMARY KEY ("Description", "SecondDrug")
)
