-- 14
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed SEGMENT_NUMBER
...
CREATE TABLE "FlightAvailable" (
	"FLIGHT_ID"	CHAR(6)	CONSTRAINT "FLTAVAIL_PK" PRIMARY KEY	NOT NULL,
	"SEGMENT_NUMBER"	INT	NOT NULL,
