-- 129
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added n
...
CREATE TABLE "ISFL_DAT" (
	...
	"CC"	TEXT,
	"DataSrc_ID"	TEXT,
	CONSTRAINT "ISFL_DAT_PrimaryKey" UNIQUE ("NDB_No", "Nutr_No", "n")
)
