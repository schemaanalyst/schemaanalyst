-- 125
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added FdGrp_Cd
...
CREATE TABLE "FOOD_DES" (
	...
	"FdGrp_Cd"	TEXT,
	"Long_Desc"	TEXT,
	CONSTRAINT "FOOD_DES_PrimaryKey" UNIQUE ("NDB_No", "FdGrp_Cd")
)
