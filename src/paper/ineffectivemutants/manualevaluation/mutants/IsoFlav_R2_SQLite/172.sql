-- 172
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged Nutr_No with SD
...
CREATE TABLE "ISFL_DAT" (
	...
	"CC"	TEXT,
	"DataSrc_ID"	TEXT,
	CONSTRAINT "ISFL_DAT_PrimaryKey" UNIQUE ("NDB_No", "SD")
)
