-- 152
-- UCColumnR
-- ListElementRemover with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnSupplier - Removed DataSrc_ID
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	TEXT,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("NDB_No", "FoodNo", "Nutr_No")
)
