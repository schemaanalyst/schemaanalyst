-- 39
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added NumSamp_QC
...
CREATE TABLE "SYBN_DTL" (
	...
	"AnalQC_Rtg"	DECIMAL,
	"NumSamp_QC"	DECIMAL	PRIMARY KEY,
	"CC"	TEXT,
