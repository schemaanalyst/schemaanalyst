-- 217
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged Nutr_No with AnalQC_Rtg
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	TEXT,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("NDB_No", "DataSrc_ID", "FoodNo", "AnalQC_Rtg")
)
