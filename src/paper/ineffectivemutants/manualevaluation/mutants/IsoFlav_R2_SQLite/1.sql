-- 1
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added DataSrc_ID

CREATE TABLE "DATA_SRC" (
	"DataSrc_ID"	DECIMAL	PRIMARY KEY	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE,
	"Authors"	TEXT,
	"Title"	TEXT,
	"Year"	DECIMAL,
	"Journal"	TEXT,
