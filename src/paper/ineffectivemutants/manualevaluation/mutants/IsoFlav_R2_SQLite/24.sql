-- 24
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added Nutr_no
...
CREATE TABLE "NUTR_DEF" (
	"Nutr_no"	TEXT	PRIMARY KEY	CONSTRAINT "NUTR_DEF_PrimaryKey" UNIQUE,
	"NutrDesc"	TEXT,
	"Unit"	TEXT
)
