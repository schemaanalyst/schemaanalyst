-- 37
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added SampPlan_Rtg
...
CREATE TABLE "SYBN_DTL" (
	...
	"SampPlan_Rtg"	DECIMAL	PRIMARY KEY,
	"AnalQC_Rtg"	DECIMAL,
	"NumSamp_QC"	DECIMAL,
	"CC"	TEXT,
