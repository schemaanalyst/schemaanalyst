-- 138
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Std_Dev
...
CREATE TABLE "SYBN_DTL" (
	...
	"NumSamp_QC"	DECIMAL,
	"CC"	TEXT,
	CONSTRAINT "SYBN_DTL_PrimaryKey" UNIQUE ("NDB_No", "DataSrc_ID", "FoodNo", "Nutr_No", "Std_Dev")
)
