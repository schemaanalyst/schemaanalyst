-- 120
-- UCColumnA
-- ListElementAdder with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Added Year
...
CREATE TABLE "DATA_SRC" (
	...
	"Start_Page"	TEXT,
	"End_Page"	TEXT,
	CONSTRAINT "DATA_SRC_PrimaryKey" UNIQUE ("DataSrc_ID", "Year")
)
