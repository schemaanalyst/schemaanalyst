-- 90
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged nameserver_key with domain_fkey
...
CREATE TABLE "nameserver" (
	...
	"domain_fkey"	INT	PRIMARY KEY	NOT NULL
)
