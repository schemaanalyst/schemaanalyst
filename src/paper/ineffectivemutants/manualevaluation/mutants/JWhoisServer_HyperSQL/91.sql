-- 91
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged country_key with short
...
CREATE TABLE "country" (
	...
	"short"	VARCHAR(2)	PRIMARY KEY	NOT NULL,
