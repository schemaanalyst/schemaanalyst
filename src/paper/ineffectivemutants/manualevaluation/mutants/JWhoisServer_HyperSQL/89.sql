-- 89
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged nameserver_key with nameserver
...
CREATE TABLE "nameserver" (
	"nameserver_key"	INT	NOT NULL,
	"nameserver"	VARCHAR(255)	PRIMARY KEY	NOT NULL,
