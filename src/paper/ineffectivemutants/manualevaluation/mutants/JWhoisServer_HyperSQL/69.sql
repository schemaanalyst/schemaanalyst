-- 69
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged mntnr_key with phone
...
CREATE TABLE "mntnr" (
	...
	"phone"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
	"fax"	VARCHAR(100),
