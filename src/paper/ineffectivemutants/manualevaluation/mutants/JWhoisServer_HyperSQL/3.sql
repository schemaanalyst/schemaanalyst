-- 3
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added registerexpire_date
...
CREATE TABLE "domain" (
	...
	PRIMARY KEY ("domain_key", "registerexpire_date")
)
