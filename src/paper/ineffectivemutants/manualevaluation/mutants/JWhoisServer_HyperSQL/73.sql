-- 73
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged mntnr_key with changed
...
CREATE TABLE "mntnr" (
	...
	"remarks"	VARCHAR(255),
	"changed"	TIMESTAMP	PRIMARY KEY	NOT NULL,
	"disabled"	SMALLINT	NOT NULL
)
