-- 55
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with holder
...
CREATE TABLE "domain" (
	...
	"remarks"	VARCHAR(255),
	"holder"	INT	PRIMARY KEY	NOT NULL,
