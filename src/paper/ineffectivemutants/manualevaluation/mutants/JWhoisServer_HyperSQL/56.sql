-- 56
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with admin_c
...
CREATE TABLE "domain" (
	...
	"remarks"	VARCHAR(255),
	"holder"	INT	NOT NULL,
	"admin_c"	INT	PRIMARY KEY	NOT NULL,
	"tech_c"	INT	NOT NULL,
	"zone_c"	INT	NOT NULL,
