-- 58
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with zone_c
...
CREATE TABLE "domain" (
	...
	"tech_c"	INT	NOT NULL,
	"zone_c"	INT	PRIMARY KEY	NOT NULL,
