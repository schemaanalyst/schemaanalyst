-- 74
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged mntnr_key with disabled
...
CREATE TABLE "mntnr" (
	...
	"remarks"	VARCHAR(255),
	"changed"	TIMESTAMP	NOT NULL,
	"disabled"	SMALLINT	PRIMARY KEY	NOT NULL
)
