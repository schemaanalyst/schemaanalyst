-- 75
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged person_key with type_fkey
...
CREATE TABLE "person" (
	...
	"type_fkey"	INT	PRIMARY KEY	NOT NULL,
	"name"	VARCHAR(255)	NOT NULL,
	"address"	VARCHAR(255)	NOT NULL,
	"pcode"	VARCHAR(20)	NOT NULL,
	"city"	VARCHAR(255)	NOT NULL,
