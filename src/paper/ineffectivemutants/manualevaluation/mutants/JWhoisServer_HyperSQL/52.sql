-- 52
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with registerexpire_date

CREATE TABLE "domain" (
	"domain_key"	INT	NOT NULL,
	"domain"	VARCHAR(255)	NOT NULL,
	"registered_date"	TIMESTAMP	NOT NULL,
	"registerexpire_date"	TIMESTAMP	PRIMARY KEY	NOT NULL,
