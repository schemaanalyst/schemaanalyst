-- 11
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added publicviewabledata
...
CREATE TABLE "domain" (
	...
	PRIMARY KEY ("domain_key", "publicviewabledata")
)
