-- 26
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added type_fkey
...
CREATE TABLE "person" (
	...
	"mntnr_fkey"	INT	NOT NULL,
	"disabled"	SMALLINT	NOT NULL,
	PRIMARY KEY ("person_key", "type_fkey")
)
