-- 51
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with registered_date

CREATE TABLE "domain" (
	"domain_key"	INT	NOT NULL,
	"domain"	VARCHAR(255)	NOT NULL,
	"registered_date"	TIMESTAMP	PRIMARY KEY	NOT NULL,
