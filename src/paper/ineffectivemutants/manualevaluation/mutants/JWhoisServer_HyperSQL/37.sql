-- 37
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added mntnr_fkey
...
CREATE TABLE "person" (
	...
	"mntnr_fkey"	INT	NOT NULL,
	"disabled"	SMALLINT	NOT NULL,
	PRIMARY KEY ("person_key", "mntnr_fkey")
)
