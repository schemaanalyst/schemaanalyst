-- 86
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged person_key with mntnr_fkey
...
CREATE TABLE "person" (
	...
	"remarks"	VARCHAR(255),
	"changed"	TIMESTAMP	NOT NULL,
	"mntnr_fkey"	INT	PRIMARY KEY	NOT NULL,
	"disabled"	SMALLINT	NOT NULL
)
