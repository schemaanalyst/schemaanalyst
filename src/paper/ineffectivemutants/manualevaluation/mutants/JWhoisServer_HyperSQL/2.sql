-- 2
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added registered_date
...
CREATE TABLE "domain" (
	...
	PRIMARY KEY ("domain_key", "registered_date")
)
