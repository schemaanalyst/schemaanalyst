-- 40
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added nameserver
...
CREATE TABLE "nameserver" (
	...
	PRIMARY KEY ("nameserver_key", "nameserver")
)
