-- 41
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added domain_fkey
...
CREATE TABLE "nameserver" (
	...
	PRIMARY KEY ("nameserver_key", "domain_fkey")
)
