-- 57
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged domain_key with tech_c
...
CREATE TABLE "domain" (
	...
	"tech_c"	INT	PRIMARY KEY	NOT NULL,
	"zone_c"	INT	NOT NULL,
