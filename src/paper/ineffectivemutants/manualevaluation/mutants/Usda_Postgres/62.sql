-- 62
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added seq
...
CREATE TABLE "weight" (
	"ndb_no"	CHAR(5)	NOT NULL,
	"seq"	CHAR(2)	PRIMARY KEY	NOT NULL,
	"amount"	INT	NOT NULL,
