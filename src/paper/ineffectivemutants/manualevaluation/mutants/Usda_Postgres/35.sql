-- 35
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added footnt_txt
...
CREATE TABLE "footnote" (
	...
	"nutr_no"	CHAR(3),
	"footnt_txt"	VARCHAR(100)	PRIMARY KEY	NOT NULL
)
