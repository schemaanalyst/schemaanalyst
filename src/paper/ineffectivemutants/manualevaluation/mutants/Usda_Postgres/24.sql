-- 24
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added ref_desc
...
CREATE TABLE "food_des" (
	...
	"survey"	CHAR(1),
	"ref_desc"	VARCHAR(100)	PRIMARY KEY,
	"refuse"	INT,
	"sciname"	VARCHAR(100),
	"n_factor"	INT,
	"pro_factor"	INT,
