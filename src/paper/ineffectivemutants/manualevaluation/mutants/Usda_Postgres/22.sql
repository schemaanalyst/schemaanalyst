-- 22
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added manufacname
...
CREATE TABLE "food_des" (
	...
	"comname"	VARCHAR(100),
	"manufacname"	VARCHAR(100)	PRIMARY KEY,
	"survey"	CHAR(1),
