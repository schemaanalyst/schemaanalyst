-- 54
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added units
...
CREATE TABLE "nutr_def" (
	"nutr_no"	CHAR(3)	NOT NULL,
	"units"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
	"tagname"	VARCHAR(100),
