-- 20
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added shrt_desc
...
CREATE TABLE "food_des" (
	...
	"shrt_desc"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
	"comname"	VARCHAR(100),
