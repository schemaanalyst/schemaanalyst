-- 51
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added stat_cmt
...
CREATE TABLE "nut_data" (
	...
	"low_eb"	INT,
	"up_eb"	INT,
	"stat_cmt"	VARCHAR(100)	PRIMARY KEY,
	"cc"	CHAR(1)
)
