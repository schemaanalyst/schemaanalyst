-- 39
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added num_data_pts
...
CREATE TABLE "nut_data" (
	...
	"num_data_pts"	INT	PRIMARY KEY	NOT NULL,
	"std_error"	INT,
	"src_cd"	INT	NOT NULL,
