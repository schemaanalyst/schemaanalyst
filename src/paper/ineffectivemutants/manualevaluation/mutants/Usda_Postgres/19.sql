-- 19
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added long_desc
...
CREATE TABLE "food_des" (
	"ndb_no"	CHAR(5)	NOT NULL,
	"fdgrp_cd"	CHAR(4)	NOT NULL,
	"long_desc"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
