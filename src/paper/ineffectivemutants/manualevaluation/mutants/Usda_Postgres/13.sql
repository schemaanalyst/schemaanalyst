-- 13
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added deriv_cd
...
CREATE TABLE "deriv_cd" (
	"deriv_cd"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
