-- 38
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added nutr_val
...
CREATE TABLE "nut_data" (
	"ndb_no"	CHAR(5)	NOT NULL,
	"nutr_no"	CHAR(3)	NOT NULL,
	"nutr_val"	INT	PRIMARY KEY	NOT NULL,
