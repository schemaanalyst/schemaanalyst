-- 7
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added issue_state
...
CREATE TABLE "data_src" (
	...
	"issue_state"	VARCHAR(100)	PRIMARY KEY,
