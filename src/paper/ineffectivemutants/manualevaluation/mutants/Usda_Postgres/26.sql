-- 26
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added sciname
...
CREATE TABLE "food_des" (
	...
	"refuse"	INT,
	"sciname"	VARCHAR(100)	PRIMARY KEY,
	"n_factor"	INT,
	"pro_factor"	INT,
	"fat_factor"	INT,
	"cho_factor"	INT
