-- 64
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added msre_desc
...
CREATE TABLE "weight" (
	...
	"seq"	CHAR(2)	NOT NULL,
	"amount"	INT	NOT NULL,
	"msre_desc"	VARCHAR(100)	PRIMARY KEY	NOT NULL,
	"gm_wgt"	INT	NOT NULL,
	"num_data_pts"	INT,
	"std_dev"	INT
)
