-- 6
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added vol_city
...
CREATE TABLE "data_src" (
	...
	"year"	INT,
	"journal"	VARCHAR(100),
	"vol_city"	VARCHAR(100)	PRIMARY KEY,
