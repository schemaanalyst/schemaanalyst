-- 65
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added gm_wgt
...
CREATE TABLE "weight" (
	...
	"gm_wgt"	INT	PRIMARY KEY	NOT NULL,
	"num_data_pts"	INT,
	"std_dev"	INT
)
