-- 2
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added pos

CREATE TABLE "categorydef" (
	"categoryid"	DECIMAL(2, 0)	NOT NULL,
	"name"	VARCHAR(32),
	"pos"	CHAR(1),
	PRIMARY KEY ("categoryid", "pos")
)
