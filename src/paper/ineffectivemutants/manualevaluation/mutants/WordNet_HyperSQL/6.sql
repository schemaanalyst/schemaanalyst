-- 6
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added casedwordid
...
CREATE TABLE "sense" (
	...
	PRIMARY KEY ("synsetid", "wordid", "casedwordid")
)
