-- 9
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added tagcount
...
CREATE TABLE "sense" (
	...
	PRIMARY KEY ("synsetid", "wordid", "tagcount")
)
