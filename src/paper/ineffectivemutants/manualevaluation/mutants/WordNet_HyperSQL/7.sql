-- 7
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added rank
...
CREATE TABLE "sense" (
	...
	PRIMARY KEY ("synsetid", "wordid", "rank")
)
