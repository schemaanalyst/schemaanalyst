-- 18
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed synset2id
...
CREATE TABLE "lexlinkref" (
	...
	PRIMARY KEY ("word1id", "synset1id", "word2id", "linkid")
)
