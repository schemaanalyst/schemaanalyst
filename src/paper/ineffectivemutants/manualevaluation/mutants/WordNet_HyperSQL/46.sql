-- 46
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged synsetid with definition
...
CREATE TABLE "synset" (
	...
	"definition"	LONGVARCHAR	PRIMARY KEY
)
