-- 95
-- UCColumnA
-- Added UNIQUE to column product_ean_code in table db_order_item
...
CREATE TABLE "db_order_item" (
	...
	"product_ean_code"	VARCHAR(13)	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	UNIQUE	NOT NULL,
	"total_price"	DECIMAL(8, 2)	NOT NULL
)
