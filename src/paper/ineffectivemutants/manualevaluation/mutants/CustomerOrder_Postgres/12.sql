-- 12
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(parent_id, id) with Pair(name, id)

CREATE TABLE "db_category" (
	"id"	VARCHAR(9)	PRIMARY KEY	NOT NULL,
	"name"	VARCHAR(30)	CONSTRAINT "db_category_parent_fk"  REFERENCES "db_category" ("id")	NOT NULL,
	"parent_id"	VARCHAR(9)
)
