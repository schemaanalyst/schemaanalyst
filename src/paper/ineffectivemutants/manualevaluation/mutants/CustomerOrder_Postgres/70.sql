-- 70
-- UCColumnA
-- Added UNIQUE to column category_id in table db_product
...
CREATE TABLE "db_product" (
	...
	"name"	VARCHAR(30)	NOT NULL,
	"category_id"	VARCHAR(9)	CONSTRAINT "db_product_category_fk"  REFERENCES "db_category" ("id")	UNIQUE	NOT NULL,
