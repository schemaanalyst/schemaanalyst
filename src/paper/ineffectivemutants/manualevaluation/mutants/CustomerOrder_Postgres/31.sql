-- 31
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged id with product_ean_code
...
CREATE TABLE "db_order_item" (
	...
	"product_ean_code"	VARCHAR(13)	PRIMARY KEY	CONSTRAINT "db_order_item_product_fk"  REFERENCES "db_product" ("ean_code")	NOT NULL,
	"total_price"	DECIMAL(8, 2)	NOT NULL
)
