-- 17
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed word2id
...
CREATE TABLE "lexlinkref" (
	...
	PRIMARY KEY ("word1id", "synset1id", "synset2id", "linkid")
)
