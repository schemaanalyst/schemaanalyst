-- 5
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added sample
...
CREATE TABLE "sample" (
	...
	PRIMARY KEY ("synsetid", "sampleid", "sample")
)
