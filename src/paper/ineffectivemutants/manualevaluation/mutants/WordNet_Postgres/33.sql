-- 33
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged linkid with recurses
...
CREATE TABLE "linkdef" (
	"linkid"	DECIMAL(2, 0)	NOT NULL,
	"name"	VARCHAR(50),
	"recurses"	CHAR(1)	PRIMARY KEY	NOT NULL
)
