-- 107
-- UCColumnE
-- ListElementExchanger with ChainedSupplier with UniqueConstraintSupplier and UniqueColumnsWithAlternativesSupplier - Exchanged lemma with wordid
...
CREATE TABLE "word" (
	"wordid"	DECIMAL(6, 0)	PRIMARY KEY	UNIQUE	NOT NULL,
