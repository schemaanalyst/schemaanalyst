-- 12
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added definition
...
CREATE TABLE "synset" (
	...
	"definition"	TEXT,
	PRIMARY KEY ("synsetid", "definition")
)
