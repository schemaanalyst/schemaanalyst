-- 47
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged wordid with lemma
...
CREATE TABLE "word" (
	"wordid"	DECIMAL(6, 0)	NOT NULL,
	"lemma"	VARCHAR(80)	PRIMARY KEY	UNIQUE	NOT NULL
)
