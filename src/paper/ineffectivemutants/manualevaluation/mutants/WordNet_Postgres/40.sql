-- 40
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged wordid with casedwordid
...
CREATE TABLE "sense" (
	...
	PRIMARY KEY ("synsetid", "casedwordid")
)
