-- 16
-- PKCColumnR
-- ListElementRemover with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnSupplier - Removed synset1id
...
CREATE TABLE "lexlinkref" (
	...
	PRIMARY KEY ("word1id", "word2id", "synset2id", "linkid")
)
