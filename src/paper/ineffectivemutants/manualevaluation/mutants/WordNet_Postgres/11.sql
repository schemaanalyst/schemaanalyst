-- 11
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added categoryid
...
CREATE TABLE "synset" (
	...
	"definition"	TEXT,
	PRIMARY KEY ("synsetid", "categoryid")
)
