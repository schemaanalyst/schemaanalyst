...
public class NistDML182NotNulls extends Schema {
    ...
    static final long serialVersionUID = -7458808787149996085L;
	...
	public NistDML182NotNulls() {
		...
		*/
		...
		idCodesCode1.setNotNull();
		idCodesCode2.setNotNull();
		idCodesCode3.setNotNull();
		idCodesCode4.setNotNull();
		idCodesCode4.setNotNull();
		idCodesCode5.setNotNull();
		idCodesCode6.setNotNull();
		idCodesCode7.setNotNull();
		idCodesCode8.setNotNull();
		idCodesCode9.setNotNull();
		idCodesCode10.setNotNull();
		idCodesCode11.setNotNull();
		idCodesCode12.setNotNull();
		idCodesCode13.setNotNull();
		idCodesCode14.setNotNull();
		idCodesCode15.setNotNull();		
		...
		*/
		...
		ordersCode1.setNotNull();
		ordersCode2.setNotNull();
		ordersCode3.setNotNull();
		ordersCode4.setNotNull();
		ordersCode5.setNotNull();
		ordersCode6.setNotNull();
		ordersCode7.setNotNull();
		ordersCode8.setNotNull();
		ordersCode9.setNotNull();
		ordersCode10.setNotNull();
		ordersCode11.setNotNull();
		ordersCode12.setNotNull();
		ordersCode13.setNotNull();
		ordersCode14.setNotNull();
		ordersCode15.setNotNull();
