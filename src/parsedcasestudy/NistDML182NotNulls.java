 ...
 * Java code originally generated: 2013/08/17 00:30:47
 *
 */
...
public class NistDML182NotNulls extends Schema {
	...
	public NistDML182NotNulls() {
		...
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE1"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE2"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE3"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE4"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE5"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE6"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE7"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE8"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE9"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE10"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE11"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE12"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE13"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE14"));
		this.createNotNullConstraint(tableIdCodes, tableIdCodes.getColumn("CODE15"));
		...
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE1"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE2"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE3"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE4"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE5"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE6"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE7"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE8"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE9"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE10"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE11"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE12"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE13"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE14"));
		this.createNotNullConstraint(tableOrders, tableOrders.getColumn("CODE15"));
	}
}
