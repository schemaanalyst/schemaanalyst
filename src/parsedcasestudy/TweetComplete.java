 ...
 * Java code originally generated: 2013/08/15 10:52:19
 *
 */
...
public class TweetComplete extends Schema {
	...
	public TweetComplete() {
		...
		tableExpandedUrls.createForeignKeyConstraint(tableExpandedUrls.getColumn("tweet_id"), tableTweets, tableExpandedUrls.getColumn("tweet_id"));
	}
}
