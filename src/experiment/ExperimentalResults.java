...
public class ExperimentalResults {
    ...
    /**
     * The name of the experimental results which will be concatenated with the
     * standard data file name
     */
    private String name;
    /**
     * The PrintWriter that can save the report on the file system, in
     * serialized format
     */
    ...
    /**
     * Reset this line of the experiment results -- called from one JVM
    ...
    /**
     * Toggle the boolean variable indicating whether or not the header has been
     * written
     */
    ...
    /**
     * Save the ExperimentalResults to a file, for use by the next JVM
     * invocation
     */
    public void save() {
        try {
