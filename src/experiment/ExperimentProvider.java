...
public class ExperimentProvider {
    ...
    /**
     * Load the global parameters from the file system and return to the
     * JUnitParams-driven experimentation framework
     */
    ...
    /**
     * Load the local parameters from the file system and return to the
     * JUnitParams-driven experimentation framework
     */
