...
public class TransactedJustInTimeSchemata extends Runner {

    private final static Logger LOGGER = Logger.getLogger(TransactedJustInTimeSchemata.class.getName());
    /**
    ...
    public static void main(String[] args) {
        new TransactedJustInTimeSchemata().run(args);
    }
