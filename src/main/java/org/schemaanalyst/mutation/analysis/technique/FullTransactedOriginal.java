...
public class FullTransactedOriginal extends Runner {

    private final static Logger LOGGER = Logger.getLogger(FullTransactedOriginal.class.getName());
    /**
    ...
    public static void main(String[] args) {
        new FullTransactedOriginal().run(args);
    }
}
