 ...
 */
public class ProgrammaticPipeline extends MutationPipeline<Schema> {
    
    private static final Logger LOGGER = Logger.getLogger(ProgrammaticPipeline.class.getName());
    private final Schema schema;
    
    public ProgrammaticPipeline(Schema schema, String producers) {
        this.schema = schema;
