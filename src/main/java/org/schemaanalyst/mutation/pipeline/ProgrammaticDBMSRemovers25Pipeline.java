 ...
 */
public class ProgrammaticDBMSRemovers25Pipeline extends MutationPipeline<Schema> {
    
    private static final Logger LOGGER = Logger.getLogger(ProgrammaticDBMSRemovers25Pipeline.class.getName());
    private final Schema schema;
    
    public ProgrammaticDBMSRemovers25Pipeline(Schema schema, String producers) {
        this.schema = schema;
        ...
        addRemover(new PercentageSamplingRemover<Schema>(0.25));
    }
