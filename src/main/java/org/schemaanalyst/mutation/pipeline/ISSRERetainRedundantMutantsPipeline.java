 ...
 */
public class ISSRERetainRedundantMutantsPipeline extends MutationPipeline<Schema> {

    private static final Logger LOGGER = Logger.getLogger(ISSRERetainRedundantMutantsPipeline.class.getName());

    public ISSRERetainRedundantMutantsPipeline(Schema schema) {
