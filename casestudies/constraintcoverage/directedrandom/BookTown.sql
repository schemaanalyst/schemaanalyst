...
-- Coverage: 16/56 (28.57143%) 
-- Time to generate: 20321ms 

-- Satisfying all constraints
-- * Success: false
-- * Time: 13474ms 
-- INSERT INTO books(id, title, author_id, subject_id) VALUES(0, '', 0, 0);
-- INSERT INTO books(id, title, author_id, subject_id) VALUES(-52, '', 0, 0);
-- INSERT INTO publishers(id, name, address) VALUES(0, '', '');
-- INSERT INTO publishers(id, name, address) VALUES(10, '', '');
-- INSERT INTO authors(id, last_name, first_name) VALUES(0, '', '');
-- INSERT INTO authors(id, last_name, first_name) VALUES(-34, '', '');
-- INSERT INTO states(id, name, abbreviation) VALUES(0, '', '');
-- INSERT INTO states(id, name, abbreviation) VALUES(96, '', '');
-- INSERT INTO my_list(todos) VALUES('');
-- INSERT INTO my_list(todos) VALUES('');
-- INSERT INTO stock(isbn, cost, retail, stock) VALUES('', 0, 0, 0);
-- INSERT INTO stock(isbn, cost, retail, stock) VALUES('e', 0, 0, 0);
...
-- INSERT INTO customers(id, last_name, first_name) VALUES(-27, '', '');
...
-- INSERT INTO favorite_books(employee_id, books) VALUES(0, '');
-- INSERT INTO employees(id, last_name, first_name) VALUES(99, '', '');
-- INSERT INTO employees(id, last_name, first_name) VALUES(98, '', '');
-- INSERT INTO editions(isbn, book_id, edition, publisher_id, publication, type) VALUES('', 0, 0, 0, '1000-01-01', '');
-- INSERT INTO editions(isbn, book_id, edition, publisher_id, publication, type) VALUES('tym', 0, 0, 0, '1000-01-01', '');
-- INSERT INTO distinguished_authors(id, last_name, first_name, award) VALUES(0, '', '', '');
-- INSERT INTO distinguished_authors(id, last_name, first_name, award) VALUES(46, '', '', '');
-- INSERT INTO varchar(100)_sorting(letter) VALUES('');
-- INSERT INTO varchar(100)_sorting(letter) VALUES('');
-- INSERT INTO subjects(id, subject, location) VALUES(0, '', '');
-- INSERT INTO subjects(id, subject, location) VALUES(67, '', '');
...
-- INSERT INTO schedules(employee_id, schedule) VALUES(79, '');
-- * Number of objective function evaluations: 100000
-- * Number of restarts: 0
/* Objective value:
 * Satisfy all constraints. Value: 0.36956521739130434783 [Sum: 0.58620689655172413794]
 	 	...
 	 	* Satisfy NOT NULL(title). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 		 		* '', allowNull: false. Value: 0
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [10] != [0]. Value: 0E-20 [Best: 0E-20]
 				 				* 10 != 0. Value: 0E-20 [Distance: 0]
 	 	* Satisfy NOT NULL(id). Value: 0E-20 [Sum: 0]
 		 		* 0, allowNull: false. Value: 0
 		 		* 10, allowNull: false. Value: 0
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [-34] != [0]. Value: 0E-20 [Best: 0E-20]
 	 	...
 	 	* Satisfy PRIMARY KEY[isbn]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[isbn]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0]
 			 			* ['e'] != ['']. Value: 0 [Best: 0]
 				 				* 'e' != ''. Value: 0 [Best: 0]
 					 					* Compound values are of different sizes. Value: 0
 	 	* Satisfy NOT NULL(isbn). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 	 	...
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [-27] != [0]. Value: 0E-20 [Best: 0E-20]
 				 				* -27 != 0. Value: 0E-20 [Distance: 0]
 	 	* Satisfy NOT NULL(id). Value: 0E-20 [Sum: 0]
 		 		* 0, allowNull: false. Value: 0
 		 		* -27, allowNull: false. Value: 0
 	 	* Satisfy NOT NULL(title). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 		 		* '', allowNull: false. Value: 0
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [98] != [99]. Value: 0E-20 [Best: 0E-20]
 				 				* 98 != 99. Value: 0E-20 [Distance: 0]
 	 	* Satisfy NOT NULL(id). Value: 0E-20 [Sum: 0]
 		 		* 99, allowNull: false. Value: 0
 		 		* 98, allowNull: false. Value: 0
 	 	* Satisfy NOT NULL(last_name). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 		 		* '', allowNull: false. Value: 0
 	 	* Satisfy CHECK[(id > 100)]. Value: 0.58620689655172413794 [Sum: 1.41666666666666666667]
 		 		* 99 > 100. Value: 0.66666666666666666667 [Distance: 2]
 		 		* 98 > 100. Value: 0.75000000000000000000 [Distance: 3]
 	 	* Satisfy PRIMARY KEY[isbn]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[isbn]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0]
 			 			* ['tym'] != ['']. Value: 0 [Best: 0]
 	 	...
 	 	* Satisfy NOT NULL(isbn). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 		 		* 'tym', allowNull: false. Value: 0
 	 	* Satisfy CHECK[((book_id IS NOT NULL) AND (edition IS NOT NULL))]. Value: 0E-20 [Sum: 0E-20]
 		 		* Value: 0E-20 [Sum: 0]
 			 			* 0, allowNull: false. Value: 0
 			 			* 0, allowNull: false. Value: 0
 		 		* Value: 0E-20 [Sum: 0]
 	 	...
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [46] != [0]. Value: 0E-20 [Best: 0E-20]
 				 				* 46 != 0. Value: 0E-20 [Distance: 0]
 	 	* Satisfy NOT NULL(id). Value: 0E-20 [Sum: 0]
 		 		* 0, allowNull: false. Value: 0
 		 		* 46, allowNull: false. Value: 0
 	 	* Satisfy PRIMARY KEY[id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 	 	...
 	 	* Satisfy PRIMARY KEY[employee_id]. Value: 0E-20 [Sum: 0E-20]
 		 		* Satisfy PRIMARY KEY[employee_id]. Value: 0
 		 		* No rows to compare with - evaluating NULL. Value: 0E-20 [Sum: 0E-20]
 			 			* [79] != [0]. Value: 0E-20 [Best: 0E-20]
 				 				* 79 != 0. Value: 0E-20 [Distance: 0]
 	 	* Satisfy NOT NULL(employee_id). Value: 0E-20 [Sum: 0]
 		 		* 0, allowNull: false. Value: 0
...
-- * Success: true
-- * Time: 0ms 
INSERT INTO books(id, title, author_id, subject_id) VALUES(0, NULL, 0, 0);
-- * Number of objective function evaluations: 2
-- * Number of restarts: 0
...
-- * Number of restarts: 0
/* Objective value:
 * Satisfy all except PRIMARY KEY[isbn]. Value: 0.33333333333333333334 [Sum: 0.50000000000000000000]
 	 	* Violate PRIMARY KEY[isbn]. Value: 0.50000000000000000000 [Sum: 1]
 		 		* Violate PRIMARY KEY[isbn]. Value: 1
 	 	* Satisfy NOT NULL(isbn). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0*/ 
...
-- * Number of restarts: 0
/* Objective value:
 * Satisfy all except PRIMARY KEY[id]. Value: 0.47368421052631578948 [Sum: 0.90000000000000000001]
 	 	* Violate PRIMARY KEY[id]. Value: 0.50000000000000000000 [Sum: 1]
 		 		* Violate PRIMARY KEY[id]. Value: 1
 	 	* Satisfy NOT NULL(id). Value: 0E-20 [Sum: 0]
 		 		* 99, allowNull: false. Value: 0
 	 	* Satisfy NOT NULL(last_name). Value: 0E-20 [Sum: 0]
 		 		* '', allowNull: false. Value: 0
 	 	* Satisfy CHECK[(id > 100)]. Value: 0.40000000000000000001 [Sum: 0.66666666666666666667]
 		 		* 99 > 100. Value: 0.66666666666666666667 [Distance: 2]*/ 
...
-- * Success: false
-- * Time: 1306ms 
-- INSERT INTO employees(id, last_name, first_name) VALUES(99, NULL, '');
-- * Number of objective function evaluations: 100000
-- * Number of restarts: 0
/* Objective value:
 * Satisfy all except NOT NULL(last_name). Value: 0.28571428571428571430 [Sum: 0.40000000000000000001]
...
-- * Success: true
-- * Time: 0ms 
INSERT INTO editions(isbn, book_id, edition, publisher_id, publication, type) VALUES('', NULL, -79, 0, '1000-01-01', '');
...
-- * Number of restarts: 0
/* Objective value:
 * Satisfy all except PRIMARY KEY[employee_id]. Value: 0.33333333333333333334 [Sum: 0.50000000000000000000]
 	 	* Violate PRIMARY KEY[employee_id]. Value: 0.50000000000000000000 [Sum: 1]
 		 		* Violate PRIMARY KEY[employee_id]. Value: 1
 	 	* Satisfy NOT NULL(employee_id). Value: 0E-20 [Sum: 0]
 		 		* 0, allowNull: false. Value: 0*/ 
